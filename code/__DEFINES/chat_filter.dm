...
#define REPORT_CHAT_FILTER_TO_USER(user, filter_result) \
	to_chat(user, span_warning("A palavra <b>[html_encode(filter_result[CHAT_FILTER_INDEX_WORD])]</b> é proibida: [html_encode(filter_result[CHAT_FILTER_INDEX_REASON])]"))
