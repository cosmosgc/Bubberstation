...
/proc/check_pda_message_against_filter(message, mob/user)
	...
	if (soft_filter_result)
		if(tgui_alert(user, "Sua mensagem contém\"[soft_filter_result[CHAT_FILTER_INDEX_WORD]]\". \"[soft_filter_result[CHAT_FILTER_INDEX_REASON]]\"Tem certeza que quer enviar?", "Soft Blocked Word", list("Yes", "No")) != "Yes")
			return FALSE
