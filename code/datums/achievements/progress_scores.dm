...
/datum/award/score/progress/fish/get_progress_string(progress_string)
	return span_greenannounce("Esta é a primeira vez que você pega um<B>[progress_string]</B>!")
...
/datum/award/score/progress/pda_themes/get_progress_string(progress_string)
	return span_greenannounce(span_tooltip("Agora você pode selecioná-lo em rodadas futuras sem ter que instalá-lo novamente", "Novo tema PDA desbloqueado:<B>[progress_string]!</B>"))
