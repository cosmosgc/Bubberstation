...
/datum/admin_ai_template/hostile_ranged/apply_controller(mob/living/target, client/user)
	...
	target.AddComponent(		/datum/component/ranged_attacks,		cooldown_time = fire_cooldown,		projectile_type = projectile_type,		projectile_sound = projectile_sound,		burst_shots = burst_shots,		burst_intervals = burst_interval,	)
