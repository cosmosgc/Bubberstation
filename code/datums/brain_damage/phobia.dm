/datum/brain_trauma/mild/phobia
	...
	scan_desc = "phobia"
	symptoms = "When exposed to a specific stimulus, experiences 		an immediate anxiety or fear response far greater than typically expected, 		leading to panic attacks or impaired social and occupational functioning. 		Physical contact such as hugging, or medication such as Psicodine may lessen the severity of the reaction."
