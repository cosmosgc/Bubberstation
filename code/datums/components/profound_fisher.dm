...
/datum/component/profound_fisher/proc/on_examine(datum/source, mob/user, list/examine_list)
	SIGNAL_HANDLER
	examine_list += span_info("Quanto[EXAMINE_HINT("held")]UO[EXAMINE_HINT("equipped")], [EXAMINE_HINT("right-click")]com uma mão vazia para abrir a interface da vara de pesca integrada.")
