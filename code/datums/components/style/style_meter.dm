/obj/item/style_meter
	...
	desc = "Coloque isso em um par de óculos para instalar um sistema de medição de estilo neles. Você ganha pontos de estilo fazendo atos elegantes e os perde por quebrar seu estilo. O estilo afeta a qualidade da sua mineração, com você sendo capaz de minar melhor o minério durante uma boa cadeia. Um HUD de dados responsivos dá a você a capacidade de refletir projéteis baseados em lavaland batendo neles com uma mão vazia. Além disso, em alto estilo, você é capaz de trocar um item em sua mão com um em sua mochila por<b>Batendo.</b>um com o outro."
...
/obj/item/style_meter/proc/on_examine(datum/source, mob/user, list/examine_list)
	...
	examine_list += span_notice("<b>Alt-click</b>Para remover o mediador de estilo.")
...
/obj/item/style_meter/multitool_act(mob/living/user, obj/item/tool)
	...
	balloon_alert(user, "Medidor[multitooled ? "" : "un"]Hackeado.")
