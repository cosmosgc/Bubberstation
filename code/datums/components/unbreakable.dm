...
/datum/component/unbreakable/proc/surge(mob/living/carbon/human/surged, new_stat)
	...
	surged.balloon_alert(surged, "Você se recusa a desistir!")//breaks balloon alert conventions by using a "!" for a fail message but that'Está tudo bem, porque...'s a pretty awesome moment
