/datum/disease/adrenal_crisis
	...
	desc = "Uma condição rara causada pelo abuso contínuo de Kronkaine. Se não for tratado o sujeito sofrerá letargia, tontura e perda periódica de consciência."
