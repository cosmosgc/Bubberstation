...
/datum/symptom/youth
	name = "Eternal Youth"
	desc = "O vírus torna-se simbioticamente conectado às células do corpo do hospedeiro, prevenindo e invertendo o envelhecimento. O vírus, por sua vez, torna-se mais resistente, espalha-se mais rápido, e é mais difícil de detectar, embora não prospere tão bem sem um hospedeiro."
	stealth = 3
	resistance = 4
	stage_speed = 4
	transmittable = -4
