/datum/disease/asthma_attack
	form = "Bronchitis"
	name = "Asthma attack"
	desc = "O sujeito está passando por uma resposta autoimune que ameaça fechar o esôfago e parar toda a respiração, levando à morte.\
Pequenos ataques de asma podem desaparecer sozinhos, mas todos são perigosos."
