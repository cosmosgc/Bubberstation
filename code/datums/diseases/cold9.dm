/datum/disease/cold9
	...
	desc = "Uma adaptação do resfriado comum, um pouco mais perigoso na natureza.\
Se não for tratado, o sujeito vai diminuir, como se estivesse parcialmente congelado."
