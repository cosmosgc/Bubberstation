/datum/disease/magnitis
	...
	desc = "Esta doença perturba o campo magnético do corpo dos sujeitos, fazendo-o agir como se fosse um poderoso ímã.\
Injeções de ferro ajudarão a estabilizar o campo."
