/datum/disease/parasite
	...
	desc = "Um parasita desconhecido, provavelmente entrando no corpo através de alimentos mal preparados, infectou o fígado do sujeito. Se não for tratada, o sujeito perderá nutrientes, e eventualmente perderá o fígado."
