...
/datum/instability_meltdown/alright/meltdown(mob/living/carbon/human/victim)
	to_chat(victim, span_notice("Na verdade, me sinto muito bem!"))
...
/datum/instability_meltdown/decloning/meltdown(mob/living/carbon/human/victim)
	to_chat(src, span_notice("Na verdade, me sinto muito bem!"))
...
/datum/instability_meltdown/organ_vomit/meltdown(mob/living/carbon/human/victim)
	...
	victim.visible_message(span_danger("[victim] vomits up [p_their()] [picked_organ.name]!"), span_danger("You vomit up your [picked_organ.name]")) //no "Vomite seu coração"
...
/datum/instability_meltdown/fatal/skeletonize/meltdown(mob/living/carbon/human/victim)
	victim.visible_message(span_warning("[victim]'s skin melts off!"), span_boldwarning("Sua pele derrete!"))
	victim.spawn_gibs()
