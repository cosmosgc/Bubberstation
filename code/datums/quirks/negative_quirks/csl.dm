/datum/quirk/csl
	...
	desc = "Comum não é sua língua nativa. É algo que você tinha que pegar no caminho.\
Algumas palavras em comum soarão estranhas, e você pode voltar para sua língua nativa.\
quando você está ansioso ou chateado."
