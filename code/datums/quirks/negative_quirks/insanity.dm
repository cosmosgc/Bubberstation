/datum/quirk/insanity
	...
	desc = "Você sofre de um distúrbio grave que causa alucinações muito vívidas e problemas para expressar suas ideias.\
A toxina destruidora de mentes pode suprimir seus efeitos, e você é imune às propriedades alucinogênicas do quebra-cabeças.\
Isto não é uma licença para o luto."
