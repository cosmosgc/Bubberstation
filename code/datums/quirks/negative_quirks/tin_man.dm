/datum/quirk/tin_man
	...
	value = -6
	medical_record_text = "Durante o exame físico, o paciente tinha vários órgãos internos protéticos de baixo orçamento.<b>A remoção desses órgãos é conhecida por ser perigosa tanto para o paciente quanto para o médico.</b>"
	hardcore_value = 6
...
/datum/quirk/tin_man/post_add()
	to_chat(quirk_holder, span_bolddanger("A maioria dos seus órgãos internos foram substituídos por próteses excedentes. Eles são frágeis e facilmente se separarão sob coação. Além disso, qualquer PEM os fará parar de funcionar completamente."))
