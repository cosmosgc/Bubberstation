/datum/quirk/evil
	...
	desc = "Onde você teria uma alma é apenas um vazio negro. Enquanto você está comprometido em manter sua posição social,\
Qualquer um que olhar muito para seus olhos frios e indiferentes saberá a verdade. Você é realmente mau. Não há nada.\
Errado com você. Você escolheu ser mau, comprometido com isso. Suas ambições vêm em primeiro lugar."
