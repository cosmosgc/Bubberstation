/datum/quirk/friendly
	name = "Friendly"
	desc = "Você dá os melhores abraços, especialmente quando está com o humor certo."
	icon = FA_ICON_HANDS_HELPING
	value = 2
	mob_trait = TRAIT_FRIENDLY
	gain_text = span_notice("Você quer abraçar alguém.")
	lose_text = span_danger("Você não se sente mais compelido a abraçar os outros.")
	quirk_flags = QUIRK_HUMAN_ONLY|QUIRK_MOODLET_BASED
	medical_record_text = "O paciente demonstra baixas inibições para contato físico e braços bem desenvolvidos. Pedindo outro médico para assumir este caso."
