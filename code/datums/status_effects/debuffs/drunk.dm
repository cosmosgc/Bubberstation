	...
	*/
	...
	if(drunk_value >= 81)
		...
		if(owner.stat == CONSCIOUS && prob(5))
			to_chat(owner, span_warning("Talvez deve se deitar um pouco..."))
...
/atom/movable/screen/alert/status_effect/drunk
	name = "Drunk"
	desc = "O álcool que tem bebido está prejudicando sua fala, habilidades motoras e cognição mental. Certifique-se de agir como tal."
