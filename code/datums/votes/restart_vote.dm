...
/datum/vote/restart_vote
	...
	default_message = "Vote para reiniciar a rodada.\
Só funciona se não houver administradores não-AFK online."
...
/datum/vote/restart_vote/proc/async_alert_about_admins(mob/vote_creator)
	set waitfor = FALSE
	tgui_alert(vote_creator, "Nota: independente dos resultados desta votação,\
A rodada não vai reiniciar automaticamente porque um administrador ativo está online.")
