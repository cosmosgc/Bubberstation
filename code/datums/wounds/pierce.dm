...
/datum/wound/pierce/bleed/moderate
	...
	treat_text = "Aplicar bandagem ou sutura na ferida, fazer uso de agentes de coagulação sanguínea,\
Cauterização, ou em circunstâncias extremas, exposição a frio extremo ou vácuo.\
Siga com comida e um período de descanso."
...
/datum/wound/pierce/bleed/severe
	...
	treat_text = "Aplique rapidamente bandagem ou sutura na ferida, faça uso de agentes de coagulação sanguínea ou soroglicose,\
Cauterização, ou em circunstâncias extremas, exposição a frio extremo ou vácuo.\
...
/datum/wound/pierce/bleed/critical
	...
	treat_text = "Imediatamente aplique bandagem ou sutura na ferida, faça uso de agentes de coagulação sanguínea ou soroglicose,\
Cauterização, ou em circunstâncias extremas, exposição a frio extremo ou vácuo.\
Siga com ressangramento supervisionado."
	treat_text_short = "Apply bandaging, suturing, clotting agents, or cauterization."
