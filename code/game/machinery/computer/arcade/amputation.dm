/obj/machinery/computer/arcade/amputation
	...
	desc = "Uma foto de um cyborg médico encharcado de sangue pisca na tela.\
O mediborg tem uma bolha de discurso que diz,\"Coloque sua mão na máquina se você não é um<b>Covarde!</b>\""
	icon_state = "arcade"
