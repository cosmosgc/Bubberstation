...
/atom/movable/proc/can_infuse(mob/feedback_target)
	if(feedback_target)
		balloon_alert(feedback_target, "Sem DNA!")
	return FALSE

/mob/living/can_infuse(mob/feedback_target)
	if(feedback_target)
		balloon_alert(feedback_target, "DNA muito simples!")
	return FALSE
...
/mob/living/carbon/human/can_infuse(mob/feedback_target)
	...
	if(HAS_TRAIT(src, TRAIT_BADDNA))
		if(feedback_target)
			balloon_alert(feedback_target, "O DNA está corrompido!")
		return FALSE
	if(!can_mutate())
		if(feedback_target)
			balloon_alert(feedback_target, "O DNA sumiu!")
		return FALSE
	return TRUE
