...
/obj/item/binoculars/proc/on_wield(obj/item/source, mob/user)
	user.visible_message(span_notice("[user]Segura.[src]até[user.p_their()]Olhos."), span_notice("Você espera.[src]Até os olhos."))
...
/obj/item/binoculars/proc/on_unwield(obj/item/source, mob/user)
	user.visible_message(span_notice("[user]Abaixa.[src]."), span_notice("Você mais baixo.[src]."))
	inhand_icon_state = "binoculars"
	user.regenerate_icons()
