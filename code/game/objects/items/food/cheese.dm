...
/obj/item/food/cheese
	...
	desc = "Isso provavelmente não deveria existir."
...
/obj/item/food/cheese/proc/on_rat_eat(datum/source, mob/living/basic/regal_rat/king)
	...
	king.cheese_heal(src, rat_heal, span_green("Você come.[src], restaurando a saúde."))
	return COMPONENT_RAT_INTERACTED

/obj/item/food/cheese/wedge
	name = "cheese wedge"
	desc = "Um pedaço de Cheddar delicioso. A roda de queijo que foi cortada não pode ter ido longe."
...
/obj/item/food/cheese/wheel
	name = "cheese wheel"
	desc = "Uma grande roda de Cheddar delicioso."
...
/obj/item/food/cheese/wheel/proc/consume_cheese()
	visible_message(span_revenwarning("...e é consumido em um vórtice de caos!"))
	do_sparks(number = 1, cardinal_only = TRUE, source = get_turf(src))
	qdel(src)

/obj/item/food/cheese/royal
	name = "royal cheese"
	desc = "Suba ao trono. Consuma a roda. Sinta o poder."
...
/obj/item/food/cheese/curd_cheese
	name = "curd cheese"
	desc = "Conhecido por muitos nomes em toda a cozinha humana, queijo coalhado é útil para uma grande variedade de pratos."
...
/obj/item/food/cheese/cheese_curds
	name = "cheese curds"
	desc = "Sem ser confundido com queijo coalhado. Saboroso frito."
...
/obj/item/food/cheese/firm_cheese
	name = "firm cheese"
	desc = "Queijo firme, semelhante em textura ao tofu firme. Devido à sua falta de umidade, é particularmente útil para cozinhar, pois não derrete facilmente."
...
/obj/item/food/cheese/firm_cheese_slice
	...
	desc = "Uma fatia de queijo firme. Perfeito para grelhar ou transformar em pesto delicioso."
...
/obj/item/food/cheese/mozzarella
	...
	desc = "Delicioso, creme e brega, tudo em um pacote simples."
