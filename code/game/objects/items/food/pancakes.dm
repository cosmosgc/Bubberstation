...
/obj/item/food/pancakes/raw/make_grillable()
	AddComponent(/datum/component/grillable,				cook_result = /obj/item/food/pancakes,				required_cook_time = rand(30 SECONDS, 40 SECONDS),				positive_result = TRUE,				use_large_steam_sprite = TRUE)
...
/obj/item/food/pancakes/raw/examine(mob/user)
	...
	if(name == initial(name))
		. += span_notice("Você pode modificar a panqueca adicionando<b>Mirtilos.</b>UO<b>chocolate</b>Antes de terminar a Grécia.")
