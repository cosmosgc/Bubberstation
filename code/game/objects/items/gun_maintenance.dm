...
/obj/item/gun_maintenance_supplies/makeshift
	...
	desc = "Uma caixa de ferramentas contendo suprimentos suficientes para jurar reparos em armas de fogo. Pode ser aplicado em armas de fogo para mantê-las.\
As ferramentas são um pouco básicas, e os materiais de baixa qualidade, mas ele faz o trabalho feito."
