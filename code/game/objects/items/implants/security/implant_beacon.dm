...
/obj/item/implant/beacon
	...
	implant_info = "Automatically activates upon implantation. Acts as a dedicated, teleport-only bluespace beacon. 		Deactivates ten minutes after host's death, but remains within the body."

	implant_lore = "The Robust Corp JMP-21 Fugitive Retrieval Implant is a subdermal bluespace transponder 		designed for interfacing with common bluespace teleporting technology and serving as a beacon that can 		be teleported directly onto. Unfortunately, it only serves as a beacon-transponder that can be locked onto, 		providing no tracking functionality. Automatically deactivates ten minutes after the host's death."
...
/obj/item/implantcase/beacon
	...
	desc = "Uma caixa de vidro contendo um implante de farol."
	imp_type = /obj/item/implant/beacon
