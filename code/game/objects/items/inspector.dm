...
/obj/item/inspector
	...
	desc = "Sistema de inspeção do Comando Central.\
Usado para varreduras de precisão para determinar se um item contém, ou é, contrabando."
...
/obj/item/inspector/interact_with_atom(atom/interacting_with, mob/living/user, list/modifiers)
	...
	if(contraband_scan(interacting_with, user))
		...
		balloon_alert(user, "Contrabando detectado!")
		return ITEM_INTERACT_SUCCESS
