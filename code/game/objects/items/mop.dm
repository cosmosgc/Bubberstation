...
/obj/item/mop/advanced/attack_self(mob/user)
	...
	user.balloon_alert(user, "Interruptor de condensador[refill_enabled ? "on" : "off"]")
...
/obj/item/mop/advanced/examine(mob/user)
	. = ..()
	. += span_notice("O interruptor do condensador está definido para<b>[refill_enabled ? "ON" : "OFF"]</b>.")
