...
/obj/item/tank/jetpack/proc/configure_jetpack(stabilize, mob/user = null)
	...
	AddComponent( 		/datum/component/jetpack, 		src.stabilize, 		drift_force, 		COMSIG_JETPACK_ACTIVATED, 		COMSIG_JETPACK_DEACTIVATED, 		JETPACK_ACTIVATION_FAILED, 		thrust_callback, 		thrust_callback, 		/datum/effect_system/trail_follow/ion, 	)
...
/obj/item/tank/jetpack/ui_action_click(mob/user, action)
	if(istype(action, /datum/action/item_action/toggle_jetpack))
		...
		if(on)
			...
			to_chat(user, span_notice("Você vira o jetpack estabilização[stabilize ? "on" : "off"]."))
	else
