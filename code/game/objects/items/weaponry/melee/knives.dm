...
/obj/item/knife/proc/set_butchering()
	AddComponent(/datum/component/butchering, 	speed = 9 SECONDS - force * 2, 	effectiveness = 100, 	bonus_modifier = force - 10, 	)
...
/obj/item/switchblade/Initialize(mapload)
	...
	AddComponent( 		/datum/component/transforming, 		start_transformed = start_extended, 		force_on = 20, 		throwforce_on = 23, 		throw_speed_on = throw_speed, 		sharpness_on = SHARP_EDGED, 		hitsound_on = 'sound/items/weapons/bladeslice.ogg', 		w_class_on = WEIGHT_CLASS_NORMAL, 		attack_verb_continuous_on = list("slashes", "slices", "tears", "lacerates", "rips", "dices", "cuts"), 		attack_verb_simple_on = list("slash", "slice", "tear", "lacerate", "rip", "dice", "cut"), 	)
...
/obj/item/boxcutter/Initialize(mapload)
	...
	AddComponent( 		/datum/component/transforming, 		start_transformed = start_extended, 		force_on = 10, 		throwforce_on = 4, 		throw_speed_on = throw_speed, 		sharpness_on = SHARP_EDGED, 		hitsound_on = 'sound/items/weapons/bladeslice.ogg', 		w_class_on = WEIGHT_CLASS_NORMAL, 		attack_verb_continuous_on = list("cuts", "stabs", "slashes"), 		attack_verb_simple_on = list("cut", "stab", "slash"), 	)
