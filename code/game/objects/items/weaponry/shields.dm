...
/obj/item/shield/energy/advanced
	...
	desc = "Um escudo de luz dura capaz de refletir todos os projéteis de energia, bem como fornecer defesa bem arredondada da maioria dos outros ataques.\
Muitas vezes empregadas por grupos de mortes de Nanotrasen."
