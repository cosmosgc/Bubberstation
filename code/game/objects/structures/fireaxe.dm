...
/obj/structure/fireaxecabinet/jawsofrecovery
	...
	desc = "Há uma pequena etiqueta que lê\"Só para uso de emergência.\"junto com detalhes para uso seguro das mandíbulas da recuperação.\
A fechadura parece precisar de uma broca cirúrgica para destrancar? Você não tem ideia de quem achou isso uma boa ideia."
