...
/obj/structure/fluff/empty_sleeper/nanotrasen
	...
	desc = "Uma câmara hiper-sono de Nanotrasen - esta parece quebrada. Há parafusos expostos para desmontar facilmente usando uma chave inglesa."
...
/obj/structure/fluff/paper
	...
	desc = "Um forro de papel espanhol pelo fundo de uma parede."
	icon = 'icons/obj/fluff/general.dmi'
	icon_state = "paper"
	deconstructible = FALSE
...
/obj/structure/fluff/divine/powerpylon
	name = "power pylon"
	desc = "Um pilar que aumenta a taxa da divina pode influenciar o mundo."
...
/obj/structure/fluff/fokoff_sign
	name = "crude sign"
	desc = "Um sinal feito com as palavras\"Fok.\"Escrito em algo tipo de tinta vermelha."
	icon = 'icons/obj/fluff/general.dmi'
	icon_state = "fokof"
...
/obj/structure/fluff/beach_umbrella
	name = "beach umbrella"
	desc = "Um guarda-chuva chique projetado para manter o sol longo da praia."
	icon = 'icons/obj/fluff/general.dmi'
	icon_state = "brella"
	density = FALSE
	anchored = TRUE
...
/obj/structure/fluff/tram_rail/electric/Initialize(mapload)
	. = ..()
	AddComponent(		/datum/component/electrified_buckle,		input_requirements = SHOCK_REQUIREMENT_AREA_POWER,		shock_immediately = TRUE,		print_message = FALSE,		damage_on_shock = 5,		loop_length = 8 SECONDS,		area_power_channel = power_channel,		shock_flags = SHOCK_NOSTUN	)
