...
/obj/structure/girder/examine(mob/user)
	...
	switch(state)
		if(GIRDER_REINF)
			. += span_notice("Os suportes são<b>Está ferrado.</b>Nenhum lugar.")
		if(GIRDER_REINF_STRUTS)
			. += span_notice("Os suportes são<i>\"Desenroso\".</i>E o interior<b>Grelha.</b>está intacto.")
		if(GIRDER_NORMAL)
			if(can_displace)
...
/obj/structure/girder/tram
	name = "tram girder"
	desc = "Estrutura de titânio para construir paredes de bonde. Pode ser banhado com<b>vidro de titânio</b>UO outros materiais de parede."
	icon = 'icons/obj/structures.dmi'
	icon_state = "tram"
	state = GIRDER_TRAM
