...
/datum/admins/proc/make_emergency_response_team(datum/ert/ertemplate = null)
	...
	var/list/mob/dead/observer/candidates = SSpolling.poll_ghost_candidates("Do you wish to be considered for [span_notice(ertemplate.polldesc)]?", check_jobban = "deathsquad", alert_pic = /obj/item/card/id/advanced/centcom/ert/commander, role_name_text = "Equipe de emergência.")
