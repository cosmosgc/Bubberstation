...
/obj/item/antag_spawner/nuke_ops/overwatch
	...
	desc = "Atribui um agente de inteligência para sua operação. Estacionados em seu próprio posto remoto, eles podem ver câmeras da estação, alarmes, e até mover a nave de infiltração!\
Além disso, todos os membros da sua operação receberão câmeras do corpo das quais podem ver seu progresso."
...
/obj/item/antag_spawner/loadout/monkey_man/proc/allergy(mob/living/second_lifer, datum/species/folly_species)
	...
	second_lifer.visible_message(span_bolddanger("[second_lifer] starts swelling unhealthily in size. It looks like they had an allergic reaction to becoming a [folly_species]!"), span_userdanger("Como seu macaco se transforma, sente suas alergias chegando. Oh, não."))
