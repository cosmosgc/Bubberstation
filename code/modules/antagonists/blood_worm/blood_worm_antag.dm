...
/datum/antagonist/blood_worm/greet()
	...
	to_chat(owner, span_bold("Uma espécie de sanguessuga espacial, enorme em tamanho e feroz na caça.\
Suas origens são desconhecidas para a maioria, mas para alguns, você está entre suas maiores criações.\
Um projeto fracassado de armas biológicas do Syndicate, exterminado por benfeitores após um\"Falta de resultados.\"E ainda assim...\
Aqui você se encontra. Em uma estação espacial Nanotrasen. Que habitat adequado para você, não é?"))
