...
/mob/eye/imaginary_friend/hivemind/greet()
	...
	greet_message += "You are now a part of the changeling hivemind, and can communicate with them freely by speaking. 		Your knowledge may be useful to them..."
	greet_message += "<br>You may also choose to <a href='byond://?src=[REF(src)];exit_hivemind=1'>exit the hivemind</a> 		if you prefer to observe instead."
...
/mob/eye/imaginary_friend/hivemind/verb/exit_hivemind()
	...
	var/response = tgui_alert(src, "Tem certeza que quer sair da colmeia? Você não pode entrar novamente, embora ainda possa ser revivido.", "Confirm Exit", list("Exit", "Stay"))
