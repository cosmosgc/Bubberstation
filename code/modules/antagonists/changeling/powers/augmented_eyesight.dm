...
/datum/action/changeling/augmented_eyesight
	...
	desc = "Cria mais varetas de sensores de luz em nossos olhos, permitindo que nossa visão penetre na maioria dos objetos de bloqueio.\
Protege nossa visão de flashes inativos."
