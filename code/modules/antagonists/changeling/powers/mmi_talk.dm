/datum/action/changeling/mmi_talk
	name = "MMI Talk"
	desc = "Nosso cérebro foi implantado em uma interface homem-máquina. Para manter nosso segredo, podemos falar através da isca como se fosse um cérebro normal. O cérebro chamará a atenção para a fala que nos ouve em roxo."
