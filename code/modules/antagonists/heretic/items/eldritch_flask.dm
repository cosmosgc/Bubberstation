...
/obj/item/reagent_containers/cup/beaker/eldritch
	...
	desc = "Tóxico para a mente fechada, mas refrescante para aqueles com conhecimento do além."
...
/obj/item/reagent_containers/cup/phylactery
	...
	desc = "Costumava roubar sangue de futuras vítimas."
	icon = 'icons/obj/antags/eldritch.dmi'
...
/obj/item/reagent_containers/cup/phylactery/interact_with_atom_secondary(atom/target, mob/living/user, list/modifiers)
	if(!COOLDOWN_FINISHED(src, drain_cooldown))
		user.balloon_alert(user, "Não posso roubar tão rápido!")
		return NONE
	if(!isliving(target))
		return NONE
...
/obj/item/ether
	...
	desc = "Um frasco de líquido verde grosso, indutor de náuseas. Restabelece seu corpo completamente, então o coloca em um sono melhorado por um minuto."
	icon = 'icons/obj/antags/eldritch.dmi'
...
/atom/movable/screen/alert/status_effect/eldritch_sleep
	...
	desc = "Você sente um calor indescritível te mantendo seguro..."
