...
/obj/item/codex_cicatrix
	name = "Codex Cicatrix"
	desc = "Este tom pesado está cheio de rabiscos enigmáticos e diagramas impossíveis.\
Segundo a lenda, pode ser decifrado revelar os segredos do véu entre mundos."
