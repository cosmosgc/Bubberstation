...
/obj/item/melee/sickly_blade/rust
	...
	desc = "Esta lâmina crescente está decrépita, desperdiçando para enferrujar.\
Mas ainda morde, rasgando carne e osso com dentes podres."
...
/obj/item/melee/sickly_blade/ash
	...
	desc = "Derretido e em bruto, um pedaço de metal dobrado em cinzas e escória.\
Desfeito, aspira ser mais do que é, e tesouras feridas cheias de fuligem com uma borda contundente."
...
/obj/item/melee/sickly_blade/flesh
	...
	desc = "Uma lâmina crescente nascida de uma criatura de carne.\
Conscientes, ele procura espalhar para os outros o sofrimento que ele suportou de suas terríveis origens."
...
/obj/item/melee/sickly_blade/void
	...
	desc = "Devoto de qualquer substância, esta lâmina reflete nada.\
É uma verdadeira representação da pureza, e caos que se segue após sua implementação."
...
/obj/item/melee/sickly_blade/dark
	...
	desc = "Uma lâmina galiante, enfeitada e rasgada.\
Furiosamente, a lâmina corta. Cicatrizes de prata a ligam para sempre ao seu propósito sombrio."
...
/obj/item/melee/sickly_blade/cosmic
	...
	desc = "Um mote de ressonância celestial, moldado em uma lâmina tecida por estrelas.\
Um exílio iridescente, esculpindo trilhas radiantes, buscando desesperadamente a unificação."
...
/obj/item/melee/sickly_blade/lock
	...
	desc = "Uma lâmina e uma chave, uma chave para o quê?\
Que grandes portões ele abre?"
...
/obj/item/melee/sickly_blade/moon
	...
	desc = "Uma lâmina de ferro, refletindo a verdade da terra, todos se unam à trupe um dia.\
Uma trupe trazendo alegria, esculpindo sorrisos em seus rostos se quiserem ou não."
...
/obj/item/melee/sickly_blade/cursed
	...
	desc = "Uma lâmina escura, amaldiçoada para sangrar para sempre. Em constante luta entre o eldritch e o escuro, é forçado a aceitar qualquer empunhador como seu mestre.\
A córnea do olho pinga sangue para o chão, mas seu olhar penetrante permanece em você."
	force = 25
	throwforce = 15
	block_chance = 35
	wound_bonus = 25
...
/obj/item/melee/sickly_blade/training
	...
	desc = "Uma lâmina dada àqueles que não podem aceitar a verdade, por pena.\
Que aja como uma bênção no curto espaço de tempo que permanece ao seu lado."
	force = 17
