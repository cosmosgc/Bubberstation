...
/obj/item/gun/ballistic/rifle/lionhunter
	...
	desc = "Um rifle antigo que parece imaculado apesar de ser claramente muito velho."
...
/obj/item/ammo_casing/strilka310/lionhunter/proc/check_fire(atom/target, mob/living/user)
	...
	if(currently_aiming)
		user.balloon_alert(user, "Já estou mirando!")
		return FALSE
...
/obj/item/ammo_box/speedloader/strilka310/lionhunter
	...
	desc = "Um clipe de stripper de munição misteriosa e atípica. Não cabe em rifles balísticos normais."
