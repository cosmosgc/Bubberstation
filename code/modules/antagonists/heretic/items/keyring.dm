...
/obj/item/card/id/advanced/heretic/examine(mob/user)
	...
	. += span_hypnophrase("<b>Usando isso em um par de portas</b>, permite que você as ligue. Entrar em uma porta irá transportá-lo para a outra, enquanto pagãos são teletransportados para uma câmara de ar aleatória.")
