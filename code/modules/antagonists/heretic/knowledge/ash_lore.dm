...
/datum/heretic_knowledge/limited_amount/starting/base_ash
	...
	desc = "Abre o Caminho de Ash para você. Permite que transmute um fósforo e uma faca em uma lâmina de Ashen. Você só pode criar cinco de cada vez." //SKYRAT EDIT two to five
...
/datum/heretic_knowledge/spell/ash_passage
	name = "Ashen Passage"
	desc = "Concede-lhe Ashen Passage, um feitiço que te deixa sair da realidade, permitindo que você atravesse uma curta distância, passando por qualquer parede. Quando for poderoso, ele vai tirá-lo de qualquer atordoamento e restrições, e terá um alcance mais longo."
...
/datum/heretic_knowledge/spell/fire_blast
	name = "Volcano Blast"
	desc = "Concede-lhe Explosão de Vulcão, um feitiço que - após uma carga curta - dispara um feixe de energia em um inimigo próximo, colocando-os em chamas e queimando-os. Se não se extinguirem, o feixe continuará para outro alvo. Quando for poderoso, tem tempo de lançamento instantâneo e explode inimigos com mais chamas."
...
/datum/heretic_knowledge/armor/ash
	desc = "Permite que transmute uma mesa (ou um terno), uma máscara e um fósforo para criar um manto queimado. Ele fornece proteção completa contra o fogo, e é capaz de produzir mais chamas passivamente. Quando tiver fogo suficiente, pode lançar versões poderosas de seus feitiços de cinzas. Atua como foco enquanto encapuza."
	gain_text = "A Sentinela permanece enquanto eles caem, desmoronando longe da vista. No entanto, os ventos soprando através da cidade chamá-los de volta ao serviço, poeira chutado para o ar, uma silhueta à deriva dos caídos."
...
/datum/heretic_knowledge/mad_mask
	...
	desc = "Permite transmutar qualquer máscara, quatro velas, um bastão de choque, e um fígado para criar uma Máscara de Loucura. A máscara infunde medo em pagãos que testemunham, causando danos à resistência, alucinações e insanidade. Também pode ser forçado a um pagão, para fazê-los incapazes de tirá-lo..."
...
/datum/heretic_knowledge/blade_upgrade/ash
	...
	gain_text = "Ele voltou, lâmina na mão, ele balançou e balançou enquanto as cinzas caíam dos céus. A cidade dele, as pessoas que ele jurou vigiar... e ver como ele fazia, como todos eles queimados em cinzas."
...
/datum/heretic_knowledge/spell/flame_birth
	...
	desc = "Concede-lhe o Renascimento do Observador Noturno, um feitiço que o extingui e queima todos os pagãos próximos que estão em chamas, curando você para cada vítima afligida. Se as vítimas estão em estado crítico, elas também morrerão instantaneamente."
	gain_text = "O fogo era inevitável, e ainda assim, a vida permaneceu em seu corpo carbonizado. O Observador da Noite era um homem em particular, sempre observando."
...
/datum/heretic_knowledge/ultimate/ash_final
	name = "Ashlord's Rite"
	desc = "O ritual de ascensão do Caminho de Ash traz 3 corpos queimados ou descascados para uma runa de transmutação para completar o ritual. Quando concluído, você se torna um prenúncio de chamas, ganhando dois abilites. Cascata, que causa um enorme e crescente anel de fogo ao seu redor, e Juramento de Chama, fazendo você criar passivamente um anel de chamas enquanto caminha. Alguns feitiços de Ashen que você já sabia também serão poderosos. Você também se tornará imune a chamas, espaço e riscos ambientais similares."
	gain_text = "O Relógio está morto, o Observador da Noite queimou com ele. Mas seu fogo arde cada vez mais, pois o Observador da Noite trouxe o rito à humanidade! Seu olhar continua, como agora estou com as chamas, testemunhando a minha ascensão, as chamas amarelas uma vez mais!"
