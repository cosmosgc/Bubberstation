...
/datum/heretic_knowledge/limited_amount/starting/base_blade
	...
	desc = "Abre o Caminho das Lâminas para você.\
Permite que transmute uma faca com uma barra de prata ou titânio para criar uma Lâmina Sundered.\
Você pode criar até quatro de cada vez."
...
/datum/heretic_knowledge/spell/realignment
	name = "Realignment"
	desc = "Concede um feitiço que realinhará seu corpo rapidamente por um curto período.\
Durante este processo, você irá regenerar rapidamente resistência e rapidamente se recuperar de atordoamentos, no entanto, você será incapaz de atacar.\
Este feitiço pode ser lançado em rápida sucessão, mas fazê-lo aumentará o resfriamento."
...
/datum/heretic_knowledge/duel_stance
	...
	desc = "Dá resistência à perda de sangue de feridas e imunidade a ter seus membros desmembrados.\
Além disso, quando danificado abaixo de 50% de sua saúde máxima,\
Você ganha maior resistência a ganhar feridas e resistência ao abrandamento."
	gain_text = "Com o tempo, foi ele que ficou sozinho entre os corpos de seus antigos companheiros, inundado de sangue, nada disso é seu.\
Ele estava sem rival, igual ou propósito."
	cost = 2
...
/datum/heretic_knowledge/armor/blade
	desc = "Permite que transmute uma mesa (ou um terno), uma máscara e uma folha de titânio ou prata para criar um Panoply Shattered.\
Fornece resistência ao bastão e isolamento de choque enquanto usado.\
Atua como foco enquanto encapuza."
	gain_text = "A cacofonia sem sentido da violência ecoa sobre mim.\
Mesmo quando a panóplia de aço do campeão foi arrancada de sua forma, cada peça ainda anseia por propósito, buscando interceptar atacantes invisíveis ou imaginados."
...
/datum/heretic_knowledge/spell/wolves_among_sheep
	...
	desc = "Altera o tecido da realidade, conjurando uma arena mágica intransponível a estranhos,\
Todos os participantes estão presos e imunes a qualquer forma de controle da multidão ou riscos ambientais;\
Os participantes presos recebem uma Lâmina e são incapazes de sair ou fugir até que eles atinjam um ataque crítico.\
Ataques críticos restauram parcialmente a saúde do Herético."
	gain_text = "Sombras rastejam pela sala, lançando cada cadeira, mesa\
e console para a forma que se aproxima de outra mão traidora.\
Eu fiz um inimigo de todos, e a paz nunca será conhecida por mim.\
De novo. Eu quebrei laços e cortei todas as alianças. Nesta verdade,\
Agora sei a fragilidade da camaradagem. Meus inimigos serão todos, divididos."
	cost = 2
...
/datum/heretic_knowledge/blade_upgrade/blade
	...
	desc = "Atacando alguém com uma lâmina em ambas as mãos.\
Agora vai dar um golpe com ambos ao mesmo tempo, lidando com dois ataques em rápida sucessão.\
O segundo golpe será um pouco mais fraco.\
Você é capaz de infundir seu punho diretamente em suas lâminas, e suas lâminas são mais eficazes contra estruturas."
	gain_text = "Eu o encontrei preso em dois, metade trancada em um duelo sem fim;\
uma rajada de lâminas, nem acertar sua marca, pois o campeão era indomável."
...
/datum/heretic_knowledge/spell/furious_steel
	name = "Furious Steel"
	desc = "Concede-lhe Aço Furioso, um feitiço alvo. Usá-lo vai convocar três\
Lâminas orbitais ao seu redor. Estas lâminas vão protegê-lo de todos os ataques,\
mas são consumidos no uso. Além disso, você pode clicar para disparar as lâminas.\
em um alvo, causando danos e sangramento."
	gain_text = "Sem pensar, peguei a faca de um soldado caído e joguei com toda a minha força. Minha mira era verdadeira!\
O Campeão da Torn sorriu ao seu primeiro gosto de agonia, e com um aceno, suas lâminas se tornaram minhas."
...
Traga 3 corpos sem cabeça ou crânio partido para uma runa de transmutação para completar o ritual.\
Quando terminarem, estarão cercados em uma constante órbita regeneradora de lâminas.\
Estas lâminas vão protegê-lo de todos os ataques, mas são consumidos no uso.\
Seu feitiço Furious Steel também terá um resfriamento mais curto.\
Além disso, você se torna um mestre de combate, ganhando imunidade total e a habilidade de encolher os ombros.\
Suas Lâminas Sunderadas causam danos bônus e curam você no ataque por uma parte dos danos causados."
	gain_text = "O Campeão da Tortura está livre! Eu me tornarei a lâmina reunida, e com minha maior ambição,\
Estou desfeito! Uma tempestade de aço e prata está sobre nós! Testemunhe minha ascensão!"
