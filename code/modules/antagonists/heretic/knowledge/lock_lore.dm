...
/datum/heretic_knowledge/limited_amount/starting/base_lock
	...
	desc = "Abre o caminho da fechadura para você.\
Permite que transmute uma faca e um pé de cabra em uma lâmina chave.\
Você só pode criar dois de cada vez e eles funcionam como pé de cabra rápido.\
Além disso, eles podem caber em cintos utilitários."
...
Bata em um par de comportas com ele para criar um par de portais, que irá teletransportá-lo entre eles, mas teletransportar não hereges aleatoriamente.\
Você pode clicar no cartão para inverter esse comportamento para portais criados.\
Cada carta só pode sustentar um par de portais ao mesmo tempo.\
Ele também funciona e parece o mesmo que um cartão de identificação regular.\
Atacá-lo com um cartão de identidade normal o consome e ganha seu acesso, e você pode usá-lo para mudar sua aparência para um cartão que você fundiu."
...
/datum/heretic_knowledge/limited_amount/concierge_rite
	...
	desc = "Permite que transmute um lápis de cera, uma tábua de madeira, e uma multitool para criar um Manual Labirinto.\
Pode materializar uma barricada ao alcance que só você e as pessoas resistentes à magia podem passar. Tem 5 cargas que se regeneram com o tempo."
...
/datum/heretic_knowledge/armor/lock
	desc = "Permite que transmute uma mesa (ou um terno), uma máscara e um pé de cabra para criar um disfarce.\
Concede camuflagem das câmeras, esconde sua identidade, voz e abafa seus passos.\
Atua como foco enquanto encapuza."
	gain_text = "Enquanto os mordomos são conhecidos pelo Concierge,\
Eles ainda consorciam entre si e com estranhos sob capas sombreadas e capas desenhadas.\
Familiaridade é traição, até para si mesmo."
...
/datum/heretic_knowledge/spell/burglar_finesse
	...
	desc = "Concede-lhe Finesse de ladrão, um feitiço de um único alvo\
Isso coloca um item aleatório da mochila das vítimas na sua mão."
...
/datum/heretic_knowledge/spell/caretaker_refuge
	...
	desc = "Te dá um feitiço que te torna transparente e não denso. Não pode ser usado perto de seres sencientes vivos.\
Enquanto está em refúgio, você não pode usar suas mãos ou feitiços, e você é imune a desacelerar.\
...
/datum/heretic_knowledge/ultimate/lock_final
	...
	desc = "O ritual de ascensão do Caminho do Knock.\
Traga 3 cadáveres sem órgãos no tronco para uma runa de transmutação para completar o ritual.\
Quando concluído, você ganha a habilidade de se transformar em criaturas eldritch poderosas.\
E suas keyblades ficarão ainda mais mortais.\
Além disso, você vai criar uma lágrima no coração do Labirinto;\
uma lágrima na realidade localizada no local deste ritual.\
Criaturas Eldritch derramarão infinitamente desta fenda\
Que estão obrigados a obedecer suas instruções."
	gain_text = "Os criados me guiaram, e eu os guiei.\
Meus inimigos eram as fechaduras e minhas lâminas eram a chave!\
O Labirinto não será mais trancado, e a liberdade será nossa! TESTEMUNHA NÓS!"
