...
/datum/heretic_knowledge/limited_amount/starting/base_moon
	...
	desc = "Abre o Caminho da Lua para você. Permite que transmute 2 folhas de vidro e uma faca em uma lâmina lunar. Você só pode criar dois de cada vez."
...
/datum/heretic_knowledge/spell/mind_gate
	name = "Mind Gate"
	desc = "Concede-lhe Mental Gate, um feitiço que silencia, ensurdece, cega, inflige alucinações, confusão, perda de oxigênio e dano cerebral ao alvo em 10 segundos. O caster leva 20 danos cerebrais por uso."
...
/datum/heretic_knowledge/moon_amulet
	...
	desc = "Permite que transmute 2 folhas de vidro, um coração e uma gravata para criar um amuleto Moonlight. Se o item é usado em alguém com baixa sanidade eles ficam furiosos atacando todo mundo, se sua sanidade não é baixa o suficiente isso diminui seu humor. Usar isso lhe dará a habilidade de ver pagãos através de paredes e tornar suas lâminas inofensivas, eles atacarão diretamente sua mente. Proporciona visão térmica e dobra o cérebro de um herege lunar quando usado."
...
/datum/heretic_knowledge/armor/moon
	desc = "Permite que transmute uma mesa (ou um terno), uma máscara e duas folhas de vidro para criar uma Regalia Resplendant, esta túnica tornará o usuário totalmente imune para desativar os efeitos e converter todas as formas de dano em dano cerebral, enquanto também pacifica o usuário e torná-lo incapaz de usar armas variadas (Lâmina de lua vai contornar o pacifismo). Atua como foco enquanto encapuza."
	gain_text = "Trilhas de luz e alegria fluiram de cada braço deste traje magnífico. A trupe girava em cascatas irresponsáveis, deslumbrantes espectadores com a verdade que buscavam. Eu observei, aproveitando-me da luz, para me encontrar."
...
/datum/heretic_knowledge/spell/moon_parade
	name = "Lunar Parade"
	desc = "Concede-lhe o Desfile Lunar, um feitiço que - após uma carga curta - envia um carnaval para frente ao bater em alguém que são forçados a participar do desfile e sofrer alucinações."
...
/datum/heretic_knowledge/blade_upgrade/moon
	...
	desc = "Sua lâmina agora causa danos cerebrais, causa alucinações aleatórias e causa danos à sanidade. Dá mais dano cerebral se a vítima está louca ou inconsciente."
...
/datum/heretic_knowledge/blade_upgrade/moon/do_melee_effects(mob/living/source, mob/living/target, obj/item/melee/sickly_blade/blade)
	...
	target.cause_hallucination( 			get_random_valid_hallucination_subtype(/datum/hallucination/body), 			"upgraded path of moon blades", 		)
...
/datum/heretic_knowledge/spell/moon_ringleader
	...
	desc = "Concede a vocês Ringleaders Rise, um feitiço AoE que causa mais danos cerebrais quanto menor a sanidade de todos na AoE e causa alucinações, com aqueles que têm menos sanidade ficando mais. Se a sanidade deles é baixa o suficiente isso os torna loucos, o feitiço então diminui sua sanidade."
	gain_text = "Agarrei a mão dele e nos levantamos. Aqueles que viram a verdade se levantaram conosco. O líder apontou e a luz fraca da verdade nos iluminou ainda mais."
...
/datum/heretic_knowledge/ultimate/moon_final
	name = "The Last Act"
	desc = "O ritual de ascensão do Caminho da Lua. Traga 3 corpos com mais de 50 danos cerebrais para uma runa de transmutação para completar o ritual. Quando concluído, você se torna um prenúncio de loucura ganhando e aura de diminuição passiva da sanidade, tripulantes com pouca sanidade serão convertidos em acólitos. 1/5 da tripulação vai se transformar em acólitos e seguir seu comando, todos eles receberão amuletos da lua."
	gain_text = "Mergulhamos em direção à multidão, sua alma se dividindo em busca de maior aventura para onde o líder do anel tinha começado o desfile, eu vou continuar para o sol TESTEMUNHO de morte Minha ascensão, a lua sorri mais e para sempre mais!"

	ascension_achievement = /datum/award/achievement/misc/moon_ascension
	announcement_text = "Rir, para o líder Name subiu! A verdade deve finalmente devorar a mentira! SPOOKY"
...
/datum/heretic_knowledge/ultimate/moon_final/proc/on_life(mob/living/source, seconds_per_tick)
	...
	for(var/mob/living/carbon/carbon_view in range(7, source))
		...
		if(should_mind_explode(carbon_view))
			to_chat(carbon_view, span_boldbig(span_red(				"Seu senso de Reel como sua mente está envolvida por outra força tentando reescrever seu próprio ser. Você não pode nem começar a gritar antes que seu implante ative seu protótipo de segurança psicológica, levando sua cabeça com ele.")))
