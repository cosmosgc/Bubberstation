...
/datum/heretic_knowledge/limited_amount/starting/base_rust
	...
	desc = "Abre o caminho da Rust para você.\
Permite que transmute uma faca com qualquer item de lixo em uma lâmina Rusty.\
...
/datum/heretic_knowledge/spell/rust_construction
	...
	desc = "Concede-lhe Rust Construction, um feitiço que permite levantar uma parede de um chão enferrujado.\
Qualquer um acima da parede será jogado de lado (ou para cima) e manter danos."
	gain_text = "Imagens de estruturas estranhas e sinistros começaram a dançar em minha mente. Coberto da cabeça aos pés em espessa ferrugem,\
Eles não pareciam mais homens. Ou talvez nunca tenham sido."
	action_to_add = /datum/action/cooldown/spell/pointed/rust_construction
	cost = 2

/datum/heretic_knowledge/armor/rust
	desc = "Permite que transmute uma mesa (ou um terno), uma máscara e qualquer item de lixo para criar um Restos Salvados.\
Tem armadura extra, resistência e imunidade da seringa enquanto está na ferrugem.\
Atua como foco enquanto encapuza."
	gain_text = "De baixo de sucata deformada, o ferreiro puxa um tecido antigo.\
				\"Seja lá o que isso já representou está perdido. Então, agora, damos um novo propósito.\""
...
/datum/heretic_knowledge/spell/area_conversion
	...
	desc = "Concede-lhe Agressive Spread, um feitiço que espalha ferrugem para superfícies próximas.\
Superfícies já enferrujadas são destruídas \ Também melhora as habilidades enferrujadas de não-heréticos ferrugem."
...
/datum/heretic_knowledge/blade_upgrade/rust
	...
	gain_text = "O ferreiro lhe dá a lâmina.\"A Lâmina te guiará através da carne, se deixar.\" \
A ferrugem pesada o reduz. Você olha profundamente para ele. As Colinas Rusted chamam por você, agora."
...
/datum/heretic_knowledge/spell/entropic_plume
	name = "Entropic Plume"
	desc = "Concede-lhe Plume Entropica, um feitiço que libera uma onda de Rust.\
Cegos, venenos, e inflige Amok em qualquer pagão que acerte, fazendo-os atacar\
em amigo ou inimigo selvagemmente. Também ferrugem e destrói e superfícies que atinge e melhora as habilidades de ferrugem de hereges não-ferrugem."
	gain_text = "A corrosão era imparável. A ferrugem era desagradável.\
O ferreiro se foi, e você segura a lâmina deles. Campeões da esperança, o Rustbringer está próximo!"
...
/datum/heretic_knowledge/ultimate/rust_final
	...
	desc = "O ritual de ascensão do Caminho da Rust.\
Traga 3 corpos para uma runa de transmutação na ponte da estação para completar o ritual.\
Quando concluído, o local ritual espalhará infinitamente ferrugem em qualquer superfície, parando por nada.\
Além disso, você se tornará extremamente resistente à ferrugem, curando ao triplo da taxa.\
e ficar imune a muitos efeitos e perigos. Você será capaz de enferrujar quase tudo ao subir."
	gain_text = "Campeão da ferrugem. Corruptor de aço. Temam a escuridão, pois o RUSTBRINGER chegou!\
O ferreiro avança! Rusted Hills, chame meu nome! Testemunhe minha ascensão!"
...
/datum/heretic_knowledge/ultimate/rust_final/recipe_snowflake_check(mob/living/user, list/atoms, list/selected_atoms, turf/loc)
	if(ritual_location)
		...
		if(!istype(our_area, ritual_location))
			loc.balloon_alert(user, "ritual failed, must be in [initial(ritual_location.name)]!") // "Deve estar na ponte."
			return FALSE
