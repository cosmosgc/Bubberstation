...
/datum/action/cooldown/spell/fire_sworn
	name = "Oath of Flame"
	desc = "Por um minuto, criará passivamente um anel de fogo ao seu redor."
...
/datum/action/cooldown/spell/pointed/ash_beams
	...
	desc = "Um feitiço poderoso que libera cinco correntes de fogo em direção ao alvo."
	background_icon_state = "bg_heretic"
	overlay_icon_state = "bg_heretic_border"
	button_icon = 'icons/mob/actions/actions_ecult.dmi'
	...
	for(var/turf/T in turfs)
		...
		for(var/mob/living/L in T.contents)
			if(L.can_block_magic())
				L.visible_message(span_danger("The spell bounces off of [L]!"), span_danger("O feitiço sai de você!"))
				continue
