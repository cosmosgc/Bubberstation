/datum/action/cooldown/spell/cosmic_rune
	name = "Cosmic Rune"
	desc = "Cria uma runa cósmica em sua posição, apenas dois podem existir de cada vez. Invocar uma runa o transporta para a outra. Qualquer um com uma marca estelar é transportado junto com você."
