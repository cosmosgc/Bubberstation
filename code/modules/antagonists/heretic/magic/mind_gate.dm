/datum/action/cooldown/spell/pointed/mind_gate
	name = "Mind Gate"
	desc = "Tem 20 danos cerebrais e o alvo sofre uma alucinação.\
fica confuso por 10 segundos, e sofre perda de oxigênio e danos cerebrais.\
Também cega, muda e ensurdece seu alvo, se sua sanidade for baixa o suficiente, eles serão derrubados também."
