...
/datum/action/cooldown/spell/cone/staggered/entropic_plume
	name = "Entropic Plume"
	desc = "Lança uma pluma desorientadora que faz os inimigos atacarem uns aos outros, brevemente os cega (aumentando com o alcance) e os envenena (diminuindo com o alcance). Também espalha ferrugem no caminho da pluma."
...
/datum/action/cooldown/spell/cone/staggered/entropic_plume/do_mob_cone_effect(mob/living/victim, atom/caster, level)
	...
	to_chat(victim, span_boldwarning("Você se sente cheio de uma raiva que não é sua!"))
...
/datum/action/cooldown/spell/basic_projectile/rust_wave
	name = "Patron's Reach"
	desc = "Canaliza energia em suas mãos para liberar uma onda de ferrugem."
	background_icon_state = "bg_heretic"
	overlay_icon_state = "bg_heretic_border"
	button_icon = 'icons/mob/actions/actions_ecult.dmi'
