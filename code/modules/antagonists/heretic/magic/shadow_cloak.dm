/datum/action/cooldown/spell/shadow_cloak
	...
	desc = "Esconde completamente sua identidade, mas não o torna invisível. Pode ser ativado cedo para desativá-lo.\
Enquanto camuflado, você se move mais rápido, mas sofre ações muito mais lentas.\
Sofrer danos enquanto está camuflado pode fazer com que ele se levante de repente, causando efeitos negativos."
