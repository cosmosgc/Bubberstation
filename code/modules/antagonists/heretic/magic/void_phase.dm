/datum/action/cooldown/spell/pointed/void_phase
	name = "Void Phase"
	desc = "Deixa você piscar para o seu destino apontado, causa 3x3 aoe bolha de danos\
em torno de seu destino apontado e sua localização atual.\
Tem um alcance mínimo de 3 peças e um alcance máximo de 9 peças."
...
/datum/action/cooldown/spell/pointed/void_phase/before_cast(atom/cast_on)
	...
	if(owner && get_dist(get_turf(owner), get_turf(cast_on)) < min_cast_range)
		cast_on.balloon_alert(owner, "Muito perto!")
