/datum/action/cooldown/spell/pointed/void_prison
	name = "Void Prison"
	desc = "Manda um pagão para o vazio por 10 segundos.\
Eles não serão capazes de realizar qualquer ação durante todo o tempo.\
Depois, eles serão refrigerados e retornados ao avião mortal."
