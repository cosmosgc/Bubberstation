...
/datum/action/cooldown/spell/wolves_among_sheep
	...
	desc = "Alterando o tecido da realidade, conjurando uma arena mágica intransponível a estranhos, todos os participantes estão presos e imunes a qualquer forma de controle da multidão ou riscos ambientais; os participantes presos recebem uma Lâmina e são incapazes de sair ou fugir até atingirem um ataque crítico."
