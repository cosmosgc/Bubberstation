...
/datum/antagonist/soultrapped_heretic/on_gain()
	...
	if(policy)
		...
		to_chat(owner, span_ghostalert("Você é a alma presa do Herege que já foi. Você pode tentar convencer seus capangas a desamarrá-lo, concedendo-lhe algum grau de liberdade, e eles têm acesso a alguns de seus poderes.\
Você foi escravizado pelo culto, mas não é membro dele, e retenha o que resta do seu livre arbítrio. Além disso, há pouco a ser feito além de comentários. Tente não ficar preso em um armário."))
