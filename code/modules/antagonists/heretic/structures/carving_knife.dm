...
/obj/item/melee/rune_carver
	name = "carving knife"
	desc = "Uma pequena faca feita de aço frio, pura e perfeita. Sua nitidez pode esculpir-se em titânio, mas poucos podem evocar os perigos que se escondem sob a realidade."
...
/obj/item/melee/rune_carver/examine(mob/user)
	...
	. += span_notice("<b>[length(current_runes)] / [max_rune_amt]</b>Entalhes totais foram feitos.")
	. += span_info("Como seguintes runas podem ser esculpidas:")
...
/obj/item/melee/rune_carver/proc/do_carve_rune(turf/open/target_turf, mob/user)
	...
	target_turf.balloon_alert(user, "Entalhando.[picked_choice]...")
	...
	target_turf.balloon_alert(user, "[picked_choice]Entalhado")
