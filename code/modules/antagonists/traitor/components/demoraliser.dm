...
/datum/mood_event/traitor_graffiti_antag
	description = "O logotipo do Sindicato? Que gentilmente ousado."
	mood_change = 2
	timeout = 2 MINUTES
	hidden = TRUE

/datum/mood_event/traitor_graffiti_crew
	description = "O logotipo do Sindicato? Estou seguro aqui?"
	mood_change = -2
	timeout = 2 MINUTES
	hidden = TRUE

/datum/mood_event/traitor_graffiti_auth
	description = "Qual desses vagabundos desenhou o logotipo do Sindicato?"
	mood_change = -3
	timeout = 2 MINUTES
	hidden = TRUE
