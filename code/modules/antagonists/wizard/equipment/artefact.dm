...
/obj/tear_in_reality/Initialize(mapload)
	...
	AddComponent(
		/datum/component/singularity, 		consume_range = TEAR_IN_REALITY_CONSUME_RANGE, 		notify_admins = !mapload, 		roaming = FALSE, 		singularity_size = TEAR_IN_REALITY_SINGULARITY_SIZE, 	)
