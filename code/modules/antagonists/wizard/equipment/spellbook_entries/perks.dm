...
/datum/spellbook_entry/perks/wormborn
	name = "Worm Born"
	desc = "Sua alma está infestada de vermes mana. Quando morrer, renascerá como um grande verme.\
Quando o verme morre, não tem tanta sorte. Infecção parasítica impede que você ligue sua alma a objetos."
	hud_icon = "wormborn"
...
/datum/spellbook_entry/perks/heart_eater
	name = "Heart Eater"
	desc = "Dá-lhe a capacidade de obter a força de vida de um ser senciente comendo seu coração.\
Além disso, você pode arrancar o coração de um ser vulnerável com suas próprias mãos.\
Comer o coração de alguém pode aumentar sua resistência a danos ou ganhar mutação aleatória.\
Corações também fornecem cura forte."
	hud_icon = "hearteater"
...
/datum/spellbook_entry/perks/slime_friends
	name = "Slime Friends"
	desc = "Slimes são seus amigos.\
A cada 15 segundos você perde alguns nutrientes e convoca um lodo maligno aleatório para lutar do seu lado."
...
/datum/spellbook_entry/perks/transparence
	name = "Transparence"
	desc = "Você se torna um pouco mais perto do mundo dos mortos.\
Projéteis passam por você, mas você perde 25% de sua saúde e você é caçado por uma terrível maldição que quer devolvê-lo à vida após a morte."
...
/datum/spellbook_entry/perks/magnetism
	name = "Magnetism"
	desc = "Você tem uma pequena anomalia gravitacional que orbita ao seu redor.\
As coisas próximas serão atraídas por você."
	hud_icon = "magnetism"
