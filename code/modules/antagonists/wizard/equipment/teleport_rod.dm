...
/obj/item/teleport_rod
	...
	desc = "Uma vara mágica que te teleporta para o local que você aponta.\
Usá-lo coloca você em um estado de fluxo, removendo alguns de seus reagentes e\
fazendo você sofrer danos de outros usos até estabilizar mais uma vez."
...
/atom/movable/screen/alert/status_effect/teleport_flux
	name = "Teleport Flux"
	desc = "Seu corpo existe em um estado de fluxo, tornando o teletransporte mais perigoso."
