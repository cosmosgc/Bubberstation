...
/obj/item/paper/guides/jobs/atmos/hypertorus
	...
	default_raw_text = "<B>Como operar o Hypertorus</B><BR>-Construa a máquina como mostra no guia principal.<BR>- Faça um gás 50/50 de trítio e hidrogênio totalizando cerca de 2000 toupeiras.<BR>-Inicie a máquina, encha o laço de refrigeração com plasma/hipernoblium e use espaço ou freezers para esfriá-lo.<BR>- Conectar a mistura de combustível na porta do injetor de combustível, permitir apenas 1000 moles na máquina para facilitar o arranque da reação<BR>- Ajuste o condutor de calor para 500 quando iniciar a reação, resetá-lo para 100 quando o nível de potência é superior a 1<BR>- Em caso de fusão, ajuste o condutor de calor para o máximo e ajuste o amortecedor de corrente para o máximo. Coloque a injeção de combustível no min. Se a saída de calor não for negativa, tente mudar os custos magnéticos até que a saída de calor seja negativa. Faça o resfriamento mais forte, coloque gases de alta capacidade de calor dentro do moderador (hipernoblium ajudará a lidar com o problema)<BR><BR>	<B>Avisos:</B><BR>Você não pode desmontar a máquina se o nível de energia está acima de 0<BR>- Você não pode poder da máquina se o nível de potência é mais de 0<BR>- Você não pode se livrar de gases se o nível de energia é mais de 5<BR>- Você não pode remover gases da mistura de fusão se eles não são hélio e antinoblium<BR>-Hypernoblium vai diminuir muito o poder da mistura.<BR>- Antinoblium vai aumentar o poder da mistura por muito mais<BR>- Gases de alta capacidade de calor são mais difíceis de aquecer/frio<BR>- Gases de baixa capacidade de calor são mais fáceis de aquecer/frio<BR>- A máquina consome 50 KW por nível de potência, atingindo 350 KW no nível de potência 6 então prepare o SM de acordo.<BR>Em caso de falta de energia, a reação de fusão continuará, mas o resfriamento irá parar.<BR><BR>O escritor do guia rápido não será responsabilizado pelos abusos e colapsos causados pelo uso do guia, use guias mais avançados para entender como os vários gases agirão como moderadores."
