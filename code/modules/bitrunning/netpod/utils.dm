...
/obj/machinery/netpod/proc/enter_matrix()
	...
	current_avatar.AddComponent( 		/datum/component/avatar_connection, 		old_mind = neo.mind, 		old_body = neo, 		server = server, 		pod = src, 		help_text = generated_domain.help_text, 		copy_body = copy_body, 	)
