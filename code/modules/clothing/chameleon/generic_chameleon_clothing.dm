...
#define BREAK_CHAMELEON_ACTION(item) do { 	var/datum/action/item_action/chameleon/change/_action = locate() in item.actions; 	_action?.emp_randomise(INFINITY); 	item.AddElement(/datum/element/empprotection, EMP_PROTECT_SELF|EMP_NO_EXAMINE); } while(FALSE)
...
/obj/item/clothing/under/chameleon
	name = "black jumpsuit"
	desc = "É um macacão simples. Tem um pequeno mostrador no pulso."
...
/obj/item/clothing/suit/chameleon
	name = "armor"
	desc = "Um conjunto cego final que protege contra danos."
	icon_state = "armor"
...
/obj/item/clothing/glasses/chameleon
	...
	desc = "Usado pela equipe de engenharia e mineração para ver estruturas e terrenos básicos através de paredes, independentemente da condição de iluminação."
	icon_state = "meson"
...
/obj/item/clothing/mask/chameleon
	name = "gas mask"
	desc = "Uma máscara que pode ser conectada a um suprimento de ar. Embora bom para esconder sua identidade, não é bom para bloquear o fluxo de gás." //More accurate
	icon_state = "gas_alt"
...
/obj/item/clothing/mask/chameleon/attack_self(mob/user)
	...
	on = !on
	to_chat(user, span_notice("O trocador de voz é agora[on ? "on" : "off"]!"))
