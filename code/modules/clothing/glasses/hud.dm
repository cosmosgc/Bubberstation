...
/obj/item/clothing/glasses/hud/proc/toggle_hud_display(mob/living/carbon/eye_owner)
	if(display_active)
		...
		balloon_alert(eye_owner, "Hud dessativado.")
		return
...
/obj/item/clothing/glasses/hud/health/night/meson
	...
	desc = "Realmente combate imediatamente."
	vision_flags = SEE_TURFS

/obj/item/clothing/glasses/hud/health/night/science
	name = "night vision medical science scanner HUD"
	desc = "Uma exibição clandestina de ciência médica que permite que os agentes encontrem capitães morrendo e o veneno perfeito para acabar com eles, tudo em completa escuridão."
