...
/datum/round_event/ghost_role/sentience/spawn_role()
	...
	while(spawned_animals < animals && candidates.len && potential.len)
		...
		to_chat(selected, span_warning("Devido à radiação anormal e/ou produtos químicos\
E/ou sorte, você ganhou inteligência nível humano\
e a capacidade de falar e entender a língua humana!"))
