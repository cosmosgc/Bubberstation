...
/datum/round_event_control/valentines
	...
	description = "Coloca as pessoas em encontros! Eles devem se proteger.\
Algumas datas terão terceiras rodas, e qualquer estranho será dado o papel de \"quebra corações\"."
