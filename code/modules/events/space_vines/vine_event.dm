/datum/round_event_control/spacevine
	...
	description = "Kudzu começa a ultrapassar a estação. Pode gerar armadilhas humanas."
...
/datum/event_admin_setup/set_location/spacevine
	input_text = "Vinhedos não tem horário local?"
...
/datum/event_admin_setup/multiple_choice/spacevine
	input_text = "Selecione mutações iniciais."
	min_choices = 0

/datum/event_admin_setup/multiple_choice/spacevine/prompt_admins()
	var/customize_mutations = tgui_alert(usr, "Selecionar mutações?", event_control.name, list("Custom", "Random", "Cancel"))
...
/datum/event_admin_setup/input_number/spacevine_potency
	input_text = "Ajuste a potência da videira (efeitos frequência de mutação + gravidade máxima)"
	max_value = 100
...
/datum/event_admin_setup/input_number/spacevine_production
	input_text = "Coloque a produção da videira (efeitos espalhando a tampa + velocidade)"
	min_value = 1
	max_value = 10
