/datum/round_event_control/wizard/imposter //Mirror Mania
	...
	description = "Spawns é uma cópia do mago."
...
/datum/round_event/wizard/imposter/start()
	for(var/datum/mind/M as anything in get_antag_minds(/datum/antagonist/wizard))
		...
		var/mob/chosen_one = SSpolling.poll_ghost_candidates("Would you like to be an [span_notice("imposter wizard")]?", check_jobban = ROLE_WIZARD, alert_pic = /obj/item/clothing/head/wizard, jump_target = W, role_name_text = "Mago impostor.", amount_to_pick = 1)
