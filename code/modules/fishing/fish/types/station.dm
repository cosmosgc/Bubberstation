...
/obj/item/fish/fryish
	name = "fryish"
	fish_id = "fryish"
	desc = "Um jovem da família Friterish de<u>delicioso</u>extremófilo, formas de vida piscina. Só não diga que você comeu \"Mainkind for Ethical Animal Treatment\"."
	icon_state = "fryish"
	sprite_width = 3
	sprite_height = 3
	average_size = 20
