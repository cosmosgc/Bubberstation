/obj/item/skillchip/acrobatics
	...
	desc = "Um antigo chip de habilidade de ponta que concedeu ao usuário um grau avançado, nível olímpico de cinestésicos para virar, girar, e absolutamente nada mais. Foi retirado do mercado pouco depois da liberação devido aos usuários danificando a integridade do chip por excesso de acrobacias, causando falhas mortais. Ele realmente coloca o 'flop' em 'Fosbury Flop'!"
	skill_name = "Spinesthetics"
	skill_description = "Permite virar e girar um ritual ilegal e perigoso."
