...
/obj/item/skillchip/matrix_taunt
	...
	desc = "Overclock, sobreponha e sobrecarregue seus sentidos cinestésicos, propriocepção e reflexos por uma pequena janela de tempo para\
Desviar-se automaticamente de projéteis disparados. Ativado por uma provocação."
