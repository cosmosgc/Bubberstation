...
/obj/item/skillchip/sabrage
	...
	skill_description = "Concede ao usuário conhecimento da estrutura complexa da fraqueza estrutural de uma garrafa de champanhe no pescoço,\
Melhorando sua proficiência em ser um exibicionista em festas de oficiais."
...
/obj/item/skillchip/disposals
	...
	desc = "Torne-se um desmancha-prazeres, alvo de lixo bem onde pertence."
	auto_traits = list(TRAIT_THROWINGARM)
	skill_name = "Dauntless Disposaler"
	skill_description = "Você tem uma habilidade estranha de pousar em unidades de eliminação."
	skill_icon = "trash-can"
	activate_message = span_notice("Você parece estar focado na unidade de eliminação.")
	deactivate_message = span_notice("A unidade de eliminação próxima desaparece no fundo de sua visão.")
