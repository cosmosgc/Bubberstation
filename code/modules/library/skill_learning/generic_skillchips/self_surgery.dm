/obj/item/skillchip/self_surgery
	...
	desc = "Um chip de habilidade contendo velhos protocolos de treinamento médico de Nanotrasen, que se poderia usar para realizar cirurgias em si mesmos.\
Este não parece estar na melhor condição. Um pouco de podridão provavelmente tornou um pouco arriscado de usar."
