...
/datum/mafia_role/mafia/thoughtfeeder
	name = "Thoughtfeeder"
	desc = "Você é uma variante metamorfo que se alimenta das memórias dos outros. Conversar durante o período noturno para coordenar com seus aliados, e matar todos os não-Changelings, usando sua habilidade de aprender os papéis das pessoas em sua vantagem."
