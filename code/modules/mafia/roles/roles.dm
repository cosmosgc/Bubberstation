...
/datum/mafia_role/proc/greet()
	...
	to_chat(body, "<span class='warningplain'><b>Certifique-se de ler.<a href=\"https://tgstation13.org/wiki/Mafia\">A página wiki</a>Para aprender mais, se você não tem idéia do que está acontecendo.</b></span>")
