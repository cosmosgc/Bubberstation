...
/obj/item/paper/crumpled/muddy/fluff/elephant_graveyard
	...
	default_raw_text = "<B>A quem pode interessar</B><BR><BR>Esta área é propriedade da Divisão de Mineração Nanotrasen.<BR><BR>Invadir nesta área é ilegal, altamente perigoso, e sujeito a várias NDAs.<br><br>Por favor, volte agora, sob lei intergaláctica seção 48-R."
