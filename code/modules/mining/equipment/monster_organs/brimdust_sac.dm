...
/atom/movable/screen/alert/status_effect/brimdust_coating
	...
	desc = "Sua poeira explosiva, impactos cinéticos farão com que detone!\
A explosão não vai prejudicá-lo enquanto não estiver sob pressão atmosférica.\
Clique neste alerta para sacudir a poeira."
