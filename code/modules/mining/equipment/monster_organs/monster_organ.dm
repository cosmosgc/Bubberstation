...
/obj/item/organ/monster_core
	name = "monster core"
	desc = "Tudo o que resta de um monstro. Este item abstrato não deve gerar.\
Vai se deteriorar rapidamente em inutilidade. Mas não se preocupe porque já é inútil."
