...
/obj/item/clothing/suit/hooded/berserker
	...
	desc = "Esta armadura hulking parece possuir algum tipo de força escura dentro, uivando em raiva, faminto por carnificina. Os parafusos auto-selantes que permitiram que este terno fosse espaço há muito tempo corroem. No entanto, a entidade selada dentro do traje parece ter fome da força vital fugaz encontrada nos restos deixados nos restos de Drakes. Alimentá-lo parece dar força a uma peça de terno, embora transforme os restos de volta em cinzas sem vida."
...
/obj/item/clothing/head/hooded/berserker
	...
	desc = "Este capacete pesado parece possuir algum tipo de força negra dentro, uivando de raiva, com fome de carnificina. Os parafusos auto-selados que permitiram que este capacete fosse espaço há muito tempo corroem. No entanto, a entidade selada dentro do traje parece ter fome da força vital fugaz encontrada nos restos deixados nos restos de Drakes. Alimentá-lo parece dar força a uma peça de terno, embora transforme os restos de volta em cinzas sem vida."
	icon_state = "berserker"
