...
/obj/item/mayhem
	...
	desc = "Uma garrafa de sangue infundida mágica, cujo irmão vai levar qualquer um por até um frenesi assassino."
...
/obj/item/clothing/head/hooded/hostile_environment/Initialize(mapload)
	. = ..()
	update_appearance()
	AddComponent(/datum/component/butchering/wearable, 	speed = 0.5 SECONDS, 	effectiveness = 150, 	bonus_modifier = 0, 	butcher_sound = null, 	disabled = null, 	can_be_blunt = TRUE, 	butcher_callback = CALLBACK(src, PROC_REF(consume)), 	)
	AddElement(/datum/element/radiation_protected_clothing)
	AddElement(/datum/element/gags_recolorable)
