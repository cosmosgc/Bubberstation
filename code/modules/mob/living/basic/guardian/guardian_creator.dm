...
/obj/item/guardian_creator
	...
	var/used_message = span_holoparasite("Todas como cartas paresm estrela em branco agora.")
...
/obj/item/guardian_creator/attack_self(mob/living/user)
	...
	var/mob/chosen_one = SSpolling.poll_ghost_candidates(
		"Você quer jogar como[span_danger("[user.real_name]'s")] [span_notice("[guardian_type_name] [mob_name]")]?",
...
/obj/item/guardian_creator/tech
	...
	failure_message = span_boldholoparasite("...erro. Por favor, conte o apoio ou tenda novamente mais tarde.")
...
/obj/item/guardian_creator/miner
	...
	used_message = span_holoparasite("Este caco parece ter perdoado todo o seu poder...")
