...
/mob/living/basic/heretic_summon/star_gazer/proc/leash_to(atom/movable/leashed, atom/movable/leashed_to)
	leashed.AddComponent(		/datum/component/leash,		owner = leashed_to,		distance = leash_range,		force_teleport_out_effect = /obj/effect/temp_visual/guardian/phase/out,		force_teleport_in_effect = /obj/effect/temp_visual/guardian/phase,	)
...
/datum/action/cooldown/spell/stargazer_laser
	name = "Star Gaze"
	desc = "Gera um enorme raio de morte que erradica tudo em seu caminho. Tem sua própria força gravitacional, sugando novas vítimas."
	background_icon_state = "bg_heretic"
	overlay_icon_state = "bg_heretic_border"
	button_icon = 'icons/mob/actions/actions_ecult.dmi'
