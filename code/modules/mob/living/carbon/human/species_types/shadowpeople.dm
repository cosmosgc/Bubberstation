...
/datum/species/shadow/get_species_description()
	return "Victims of a long extinct space alien. Their flesh is a sickly 		seethrough filament, their tangled insides in clear view. Their form 		is a mockery of life, leaving them mostly unable to work with others under 		normal circumstances."
...
/datum/species/shadow/create_pref_unique_perks()
	...
	to_add += list(
		list(
			...
			SPECIES_PERK_DESC = "Sua pele floresce na escuridão. Todos os tipos de danos, não importa o quão extremos, irão se curar com o tempo enquanto não houver luz.",
		),
		list(
			SPECIES_PERK_TYPE = SPECIES_POSITIVE_PERK,
		...
		list(
			...
			SPECIES_PERK_DESC = "Sua carne murcha na luz. Qualquer exposição à luz é incrivelmente dolorosa para a sombra, carbonizando sua pele.",
		),
	)
