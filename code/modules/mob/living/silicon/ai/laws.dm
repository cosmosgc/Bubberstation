...
/mob/living/silicon/ai/proc/show_laws_verb()
	...
	set name = "Show Laws"
	set desc = "Check what your laws are privately. 		Also ensures all synced cyborgs are up to date with your laws, reminds them of your laws."
	if(usr.stat == DEAD)
...
/mob/living/silicon/ai/try_sync_laws()
	for(var/mob/living/silicon/robot/borgo in connected_robots)
		if(borgo.try_sync_laws())
			to_chat(borgo, span_bold("Sua IA te lembrou de suas leis:"))
			borgo.show_laws()
