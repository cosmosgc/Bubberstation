...
/obj/item/mod/module/welding
	...
	desc = "Um módulo instalado na viseira do terno, projeta uma sobreposição polarizada e holográfica diante dos olhos do usuário. Ele é classificado como alto o suficiente para imunidade contra extremidades, como soldar manchas e arcos, eclipses solares e lanternas portáteis."
	icon_state = "welding"
	complexity = 1
...
/obj/item/mod/module/t_ray
	...
	desc = "Um módulo instalado na viseira do terno, permitindo que o usuário use um pulso de radiação terahertz para ecolocar essencialmente coisas sob o chão, principalmente cabos e tubos. Um grampo da atmosfera funciona, e contra-troca de trabalho."
	icon_state = "tray"
...
/obj/item/mod/module/magboot
	...
	desc = "Estes são poderosos eletroímãs montados nas botas do terno, permitindo aos usuários uma excelente tração, não importa a condição dentro de casa, e essencialmente pegar uma carona no exterior de um casco. No entanto, esses modelos básicos não possuem sistemas computadorizados para automaticamente ligá-los e desligá-los, assim, numerosos usuários relatam certa aderência aos seus passos."
	icon_state = "magnet"
	module_type = MODULE_TOGGLE
	complexity = 2
	active_power_cost = DEFAULT_CHARGE_DRAIN * 0.5
...
/obj/item/mod/module/tether
	...
	desc = "Um gancho personalizado alimentado por um guincho capaz de transportar o usuário. Enquanto alguns modelos mais antigos de grapples orientados para carga têm capacidades de algumas toneladas, estes são apenas capazes de trabalhar em ambientes de gravidade zero, uma bênção para alguns engenheiros."
	icon_state = "tether"
...
/obj/item/tether_anchor/examine(mob/user)
	. = ..()
	. += span_info("Pode ser seguro usando uma chave inglesa. Use o botão direito para se amarrar.[src].")
...
/obj/item/mod/module/rad_protection
	...
	desc = "Um módulo que utiliza polímeros e blindagem reflexiva para proteger o usuário contra radiação ionizante, um perigo comum no espaço. Isso vem com software para avisar o usuário que eles estão em uma área radioativa, dando uma voz para um assassino silencioso."
...
/obj/item/mod/module/constructor
	...
	desc = "Este módulo ocupa inteiramente o antebraço do usuário, causando, notavelmente, conflito com os servos de braço avançados destinados a transportar tripulantes. No entanto, funciona como um scanner de holograma de construção extremamente avançado, além de conter os esquemas de engenharia mais recentes combinados com a memória incorporada para ajudar o usuário a construir paredes."
...
/obj/item/mod/module/headprotector
	...
	desc = "Uma série de placas de amortecimento são instaladas ao longo das áreas de trás e superior do capacete. Essas placas absorvem choques cinéticos bruscos entregues ao crânio. A maior parte deste módulo impede que ele seja instalado em qualquer terno capaz de combater ajustes de armadura. No entanto, a natureza rudimentar do módulo torna relativamente fácil de instalar na maioria dos outros ternos."
	icon_state = "welding"
	complexity = 1
