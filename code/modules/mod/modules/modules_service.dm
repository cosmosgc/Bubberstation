...
/obj/item/mod/module/bikehorn
	...
	desc = "Um pedaço montado no ombro de artilharia sônica pesada, este módulo usa a melhor tecnologia de manipulador de femto para fornecer precisamente um aperto quase letal para... uma buzina de bicicleta, produzindo um som significativamente memorável."
	icon_state = "bikehorn"
...
/obj/item/mod/module/balloon/advanced
	...
	desc = "Uma tecnologia relativamente nova desenvolvida pelos melhores engenheiros de palhaços para fazer balões longos e balões de animais a uma taxa apropriada."
...
/obj/item/mod/module/microwave_beam
	...
	desc = "Um dispositivo estranhamente doméstico, este módulo é instalado na palma da mão do usuário, conectando-se com scanners de culinária localizados no capacete para explodir alimentos com radiação precisa de micro-ondas, permitindo-lhes cozinhar alimentos à distância, com a maior facilidade. Não recomendado para uso contra uvas."
...
/obj/item/mod/module/waddle
	...
	desc = "Algumas das tecnologias mais primitivas em uso pela Honk Co. Este módulo funciona com um sistema automático de intenção, utilizando sua sensibilidade às ondas cerebrais do piloto para ler diretamente seu próximo passo, afetando as botas em que estão instaladas. Empregando uma unidade gravitônica de ligação dupla para criar rajadas etéreas miniaturizadas de espaço-tempo sob os pés do usuário, isso lhes permite... andar por aí, pulando de um lado para o outro com um impulso em seu passo."
	icon_state = "waddle"
	complexity = 1
