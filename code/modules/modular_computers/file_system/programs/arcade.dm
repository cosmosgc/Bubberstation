/datum/computer_file/program/arcade
	...
	extended_desc = "Este porto do clássico jogo \"Outbomb Cuban Pete\", redesenhou para rodar em tablets, com gráficos emocionantes e contos de histórias."
...
/datum/computer_file/program/arcade/eazy
	...
	extended_desc = "Algum tipo de conversão feita por fãs do clássico jogo \"Outbomb Cuban Pete\". Este te fez lutar contra o mais fraco George Melon."
	boss_hp = 40
	boss_mp = 10
	player_hp = 35
	player_mp = 15
