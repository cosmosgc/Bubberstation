...
/datum/active_bet/proc/advertise_bet()
	...
	newscaster_message = GLOB.news_network.submit_article("The bet [name] has started, place your bets now!", "Aplicativo de apostas espaciais da NTOS", NEWSCASTER_SPACE_BETTING, null, update_alert = should_alert)
