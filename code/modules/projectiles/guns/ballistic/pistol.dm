...
/obj/item/gun/ballistic/automatic/pistol/clandestine/fisher
	...
	desc = "Uma variante modificada do Ansem, sucessor espiritual do Makarov, com um supressor integral e gatilho de botão no aperto\
para um disruptor subbarril, similar em operação ao SC/FIsher autônomo. Chambered em 10mm."
...
Isso permite disparar uma explosão rápida de 2 balas. Chambered em 45."
	icon_state = "reagle"
	inhand_icon_state = "deagleg"
	burst_size = 2
	burst_delay = 1
...
/obj/item/gun/ballistic/automatic/pistol/doohickey
	...
	desc = "Um mal feito 3D impresso\"Arma.\"Só capaz de disparar um único tiro."
