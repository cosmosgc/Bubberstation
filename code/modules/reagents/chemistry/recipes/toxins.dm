...
/datum/chemical_reaction/formaldehyde
	...
	mix_message = "A mistura falha e produz um cheiro feroz."
...
/datum/chemical_reaction/itching_powder
	...
	mix_message = "A mistura emite gases irritantes do nariz."
	is_cold_recipe = FALSE
	required_temp = 280
	optimal_temp = 360
	overheat_temp = 700
...
/datum/chemical_reaction/facid
	...
	mix_message = "As bolhas de mistura fervilham."
	is_cold_recipe = FALSE
	required_temp = 380
	optimal_temp = 680
	overheat_temp = 800
...
/datum/chemical_reaction/lipolicide
	...
	mix_message = "A mistura fica turva."
	is_cold_recipe = FALSE
	required_temp = 100
	optimal_temp = 450
	overheat_temp = 900
...
/datum/chemical_reaction/mutetoxin //i'll just fit this in here snugly between other unfun chemicals :v
	...
	mix_message = "A mistura se acalma."
	is_cold_recipe = FALSE
	required_temp = 100
	optimal_temp = 450
	overheat_temp = 900
...
/datum/chemical_reaction/anacea
	...
	mix_message = "A mistura se transforma em uma estranha lama verde."
	is_cold_recipe = FALSE
	required_temp = 100
	optimal_temp = 450
	overheat_temp = 900
