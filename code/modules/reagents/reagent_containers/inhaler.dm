...
/obj/item/inhaler/proc/try_remove_canister(mob/living/user, modifiers)
	...
	if (canister.removal_time > 0)
		balloon_alert(user, "removendo o cilindro...")
		if (!do_after(user, canister.removal_time, src))
			return FALSE

	balloon_alert(user, "O cilindro foi removido.")
...
/obj/item/inhaler/proc/try_insert_canister(obj/item/reagent_containers/inhaler_canister/new_canister, mob/living/user, params)
	if (!isnull(canister))
		balloon_alert(user, "Remova o recipiente existente!")
		return FALSE

	balloon_alert(user, "Inserindo recipiente...")
...
/obj/item/reagent_containers/inhaler_canister/albuterol
	...
	desc = "Uma pequena lata cheia de reagentes aerossolizados para uso em um inalador. Este contém albuterol, um potente broncodilatador que pode parar.\
Ataques de asma em seus rastros."
	icon_state = "canister_medical"
...
/obj/item/reagent_containers/inhaler_canister/albuterol/asthma
	...
	desc = "Uma pequena lata cheia de reagentes aerossolizados para uso em um inalador. Este contém albuterol, um potente broncodilatador que pode parar.\
Ataques de asma em seus rastros. Parece ser uma variante de baixa pressão, e só pode aguentar 20u."
