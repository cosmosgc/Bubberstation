/datum/action/cooldown/spell/pointed/swap
	name = "Swap"
	desc = "Este feitiço permite trocar de lugar com qualquer ser vivo.\
Marque um alvo secundário de troca. Este alvo secundário será descartado quando você trocar,\
Ou então você pode clicar em si mesmo com o RMB para descartar seu alvo secundário."
