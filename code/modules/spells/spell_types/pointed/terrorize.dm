/datum/action/cooldown/spell/pointed/terrorize
	name = "Terrorize"
	desc = "Projete-se na mente de uma vítima, infligindo-lhe com terror. Prey ficará cada vez mais aterrorizada. Trocar presas aterrorizadas com uma mão aberta vai assustá-las e desorientá-las."
