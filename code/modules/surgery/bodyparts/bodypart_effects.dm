...
/datum/status_effect/grouped/bodypart_effect/plasma_based/tick(seconds_between_ticks)
	...
	if(owner.ignite_mob())
		owner.visible_message(span_danger("[owner]'s body reacts with the atmosphere and bursts into flames!"), span_userdanger("Seu corpo reage com a atmosfera e explode em chamas!"))
