...
/obj/item/organ/heart/cybernetic/tier2
	...
	desc = "Um dispositivo eletrônico projetado para imitar as funções de um coração humano orgânico. Em caso de lacerações ou hemorragia, o coração rapidamente começa a auto-replicar sangue artificial. No entanto, isso pode causar a formação de toxinas na corrente sanguínea para o processo de replicação imperfeito."
...
/obj/item/organ/heart/cybernetic/tier3
	...
	desc = "Um dispositivo eletrônico projetado para imitar as funções de um coração humano orgânico. Em caso de trauma físico, o coração tem segurança temporária para manter a estabilidade do paciente e mobilidade por um breve momento. Além disso, o coração é capaz de auto-replicar sangue sem risco de acúmulo de toxina."
...
/obj/item/organ/heart/cybernetic/surplus
	...
	desc = "Uma frágil zombaria de um coração humano que se parece mais com uma bomba de água do que com um coração real. Não oferece proteção contra PEMs."
