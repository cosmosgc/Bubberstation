...
/obj/item/organ/heart/ethereal/proc/on_take_damage(datum/source, damage, damagetype, def_zone, ...)
	...
	ethereal.visible_message(
		...
		span_warning("Os cristais em seu corpo quebraram completamente."),
	)
...
/obj/structure/ethereal_crystal/proc/heal_ethereal()
	...
	to_chat(regenerating, span_notice("Você saiu do cristal com vigor...</span><span class='userdanger'>Mas a um custo."))
