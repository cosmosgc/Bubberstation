...
/obj/item/organ/liver/feel_for_damage(self_aware)
	...
	if(damage < high_threshold)
		return span_warning("Sua[self_aware ? "liver" : "lower abdomen"]Sinto dor.")
	return span_boldwarning("Sua[self_aware ? "liver" : "lower abdomen"]Parece que está pegando fogo!")
...
/obj/item/organ/liver/cybernetic/surplus
	...
	desc = "Um fígado protético muito barato, massa produzida para alcoólatras com baixo funcionamento... Parece mais um filtro de água do que um fígado de verdade. Muito frágil, absolutamente terrível em filtrar toxinas e substancialmente fraco em álcool. Não oferece proteção contra PEMs."
