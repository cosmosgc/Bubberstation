...
/datum/tgui_panel/proc/on_initialize_timed_out()
	...
	SEND_TEXT(client, span_userdanger("Não conseguiu carregar o chat chique, clique.<a href='byond://?src=[REF(src)];reload_tguipanel=1'>Aqui.</a>para tentar recarregar."))
