...
/datum/action/vehicle/sealed/mecha/swap_seat/Trigger(mob/clicker, trigger_flags)
	...
	if(chassis.occupants.len == chassis.max_occupants)
		chassis.balloon_alert(owner, "Outro assento ocupado!")
		return
	...
	chassis.is_currently_ejecting = FALSE
	if(owner in drivers)
		chassis.balloon_alert(owner, "Controlando o assento do atirador.")
		...
		chassis.balloon_alert(owner, "assento piloto controlador")
