...
/obj/item/circuit_component/router
	display_name = "Router"
	desc = "Copia a entrada escolhida por\"Seletor de Entrada\"Para a saída escolhida por\"Seletor de Saída\"."
	category = "Utility"
...
/obj/item/circuit_component/router/multiplexer
	...
	desc = "Copia a entrada escolhida por\"Seletor de Entrada\"para a saída."
