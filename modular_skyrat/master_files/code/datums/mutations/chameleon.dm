...
/datum/action/cooldown/spell/chameleon_skin_activate
	...
	desc = "Os cromatophores em sua pele ajustar ao seu ambiente, contanto que você fique parado."
...
/datum/action/cooldown/spell/chameleon_skin_activate/proc/chameleon_skin_deactivate(mob/user = usr)
	...
	user.alpha = 255
	to_chat(user, text("Sua pele muda quando brilha de volta para suas cores originais."))
