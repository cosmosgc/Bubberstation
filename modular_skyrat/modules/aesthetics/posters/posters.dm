...
/obj/structure/sign/poster/contraband/crocin_pool
	name = "SWIM"
	desc = "Este cartaz diz dramaticamente: \"SWIM\". Parece ser publicidade o uso de Crocin .. 'recreativamente', em casa, no trabalho, e, o mais sinistro, 'a piscina'. Um logotipo \"Tramsem Mamo\" está no canto."
	icon = 'modular_skyrat/modules/aesthetics/posters/contraband.dmi'
...
/obj/structure/sign/poster/contraband/nri_engineer
	name = "Build, Now"
	desc = "Este cartaz mostra um engenheiro de combate imperial olhando para a esquerda do espectador. As palavras \"Construir, Agora\" estão escritas em cima e em baixo do cartaz."
	icon = 'modular_skyrat/modules/aesthetics/posters/contraband.dmi'
