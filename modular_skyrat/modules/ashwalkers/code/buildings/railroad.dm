...
/obj/item/stack/rail_track/interact_with_atom(atom/interacting_with, mob/living/user, list/modifiers)
	...
	if(check_rail || !use(1))
		return NONE
	to_chat(user, span_notice("Seu lugar.[src]Vamos.[target_turf]."))
...
/obj/vehicle/ridden/rail_cart/examine(mob/user)
	. = ..()
	. += span_notice("<br><b>Alt-Click</b>para analisar um carrinho de trem a este carrinho.")
	. += span_notice("<br>Preenchendo com<b>10 area.</b>permitirá que seja usado como plantador!")
