/obj/machinery/health_station
	...
	desc = "A N-URSEI, mais conhecida como simplesmente \"Enfermeira\", é um produto conhecido da tecnologia médica na CIN. O nome é de origem disputada,\
mas acredita-se ser baseado em modelos mais velhos, menos portáteis carinhosamente referidos como 'ursos-mãe' que exigia caminhões de luz especializados para transportar para o campo.\
Esses modelos menos instáveis são capazes de diagnóstico, tratamento, prevenção e prognóstico.\
empregando síntese limitada de medicamentos para preencher os modelos proprietários e não marcados de medipens."
...
/obj/machinery/health_station/proc/open_options_menu(mob/living/carbon/user)
	...
	switch(choice)
		if("Health Scan")
			...
			chemscan(user, user)
			balloon_alert(user, "analisando sinais vitais.")
...
/obj/item/wallframe/health_station
	...
	desc = "Um posto de saúde não montado. Coloque em uma parede para usar."
	icon = 'modular_skyrat/modules/bitrunning/icons/health_station.dmi'
