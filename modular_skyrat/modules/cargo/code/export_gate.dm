...
/obj/machinery/export_gate/examine()
	...
	. += span_info("Rendimento do último ciclo:<b>[income_previous]Cr.</b>")
	. += span_info("Compartilhar por conta no último ciclo:<b>[income_share]Cr.</b>")
	. += span_info("Modo de pagamento:<b>[display_payment_mode()].</b>")
	. += span_info("Contas registradas da tripulação no último ciclo:<b>[LAZYLEN(payment_accounts)]</b>")
	. += span_info("Total de cubos registrados:<b>[cubes_registered]</b>")
	. += span_info("Rendimento total:<b>[income_total]Cr.</b>")
