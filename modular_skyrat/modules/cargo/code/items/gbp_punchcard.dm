...
/obj/item/gbp_punchcard
	...
	desc = "O programa Good Assistant Points é projetado para complementar a renda de indivíduos desempregados ou não pagos a bordo de navios e colônias Nanotrasen.<br>\
Basta ter seu cartão carimbado pelo PDA de um Chefe de Estado-Maior para ganhar 150 créditos por soco em uma máquina Good Assistant Point!<br>\
No máximo seis socos por cada carta. Cartão substituído após a redenção do cartão existente. Não perca seu cartão de soco."
