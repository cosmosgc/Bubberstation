...
/datum/scripture/slab/hateful_manacles/apply_effects(mob/living/carbon/target_carbon)
	...
	target_carbon.visible_message(span_danger("[invoker]Forma um poço de energia ao redor.[target_carbon], latão aparecendo em seus pulsos!"),						span_userdanger("[invoker]Está tentando te conter!"))
