...
/obj/machinery/plumbing/synthesizer/water_synth
	...
	desc = "Um dispositivo infinitamente útil para aqueles que se encontram numa fronteira sem uma fonte estável de água. Usando uma versão simplificada do processo sintetizador do distribuidor de química, ele pode criar água com nada além de boa e velha eletricidade."
...
/obj/machinery/plumbing/synthesizer/colony_hydroponics
	...
	desc = "Um dispositivo infinitamente útil para aqueles que se encontram em uma fronteira sem uma fonte estável de nutrientes para as culturas. Usando uma versão simplificada do processo sintetizador do dispensador de química, ele pode criar nutrientes hidropônicos a partir de nada além da boa e velha eletricidade."
	icon = 'modular_skyrat/modules/colony_fabricator/icons/chemistry_machines.dmi'
...
/obj/machinery/chem_dispenser/frontier_appliance
	...
	desc = "Cria e dispensa um pequeno conjunto pré-definido de produtos químicos e outros líquidos para a conveniência daqueles tipicamente na fronteira. Enquanto a máquina é amada por muitos, ela também tem a reputação de fazer alguns dos piores cafés deste lado da galáxia. Use por sua conta e risco."
	icon = 'modular_skyrat/modules/colony_fabricator/icons/chemistry_machines.dmi'
