/obj/machinery/microwave/frontier_printed
	desc = "Um forno de microondas de painéis plásticos, capaz de fazer qualquer coisa que um micro-ondas padrão pudesse fazer.\
Este é especial projetado para ser firmemente embalado em uma forma que pode ser facilmente montado\
Depois da fábrica. Parece que não há instruções para dobrá-lo.\
Mas juntos..."
