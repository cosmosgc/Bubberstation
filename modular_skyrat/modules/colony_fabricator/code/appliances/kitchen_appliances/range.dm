/obj/machinery/oven/range_frontier
	name = "frontier range"
	desc = "Um forno combinado e fogão comumente visto na fronteira. Vem da fábrica empacotada.\
em um formato perfeitamente compacto que pode então ser implantado em um aparelho quase de tamanho completo.\
Parece, no entanto, que o designer esqueceu de incluir instruções sobre embalar essas coisas de volta."
