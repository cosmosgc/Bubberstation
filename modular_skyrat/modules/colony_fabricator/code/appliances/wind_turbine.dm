/obj/machinery/power/colony_wind_turbine
	...
	desc = "Um poste com duas lâminas de turbina vertical especialmente projetadas ligadas aos seus lados. Quando colocado ao ar livre em um planeta com uma atmosfera, produzirá uma pequena gota de poder de graça. Se houver uma tempestade na área a turbina é colocada, a produção de energia se multiplicará significativamente."
