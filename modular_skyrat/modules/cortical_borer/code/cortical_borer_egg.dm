/obj/effect/mob_spawn/ghost_role/borer_egg
	...
	flavour_text = "Você é um furo cortical! Você pode temer alguém para fazê-los parar de se mover, mas certifique-se de habitá-los! Você só cresce/cura/fala quando dentro de um hospedeiro!"
	important_text = "Como um chato, você tem a opção de ser amigável ou não. Note que como você age determinará como um hospedeiro responde. Não recorra sem palavras à mecânica dentro de um hospedeiro. Você pode falar com outros furadores usando; e seu anfitrião apenas falando normalmente. Você é incapaz de falar fora de um hospedeiro, mas é capaz de emocionar."
...
/obj/item/borer_egg/attack_self(mob/user, modifiers)
	to_chat(user, span_notice("Você esmaga[src]ao seu alcance."))
