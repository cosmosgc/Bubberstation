...
/datum/species/hemophage/get_species_description()
	return "Oftentimes feared or pushed out of society for the predatory nature of their condition, 		Hemophages are typically mixed around various Frontier populations, keeping their true nature hidden while 		reaping both the benefits and easy access to prey, enjoying unpursued existences on the Frontier."
...
/datum/species/hemophage/create_pref_unique_perks()
	...
	to_add += list(
		list(
			...
			SPECIES_PERK_DESC = "Um Hemófago só está em casa na escuridão, a infecção dentro de um Hemófago procurando devolvê-los a um estado saudável sempre que pode estar na sombra. No entanto, a luz artificial ou de outra forma irrita seus corpos e o câncer mantê-los vivos, não prejudicá-los, mas impedi-los de regenerar. Os hemofármacos modernos têm sido conhecidos por usar armários como uma fonte conveniente de escuridão, enquanto a proteção extra que eles fornecem contra radiações de fundo permite que seu tumor evite ter que gastar qualquer sangue para manter funções corporais mínimas enquanto seu hospedeiro permanecer estacionado no armário.",
		),
		list(
			SPECIES_PERK_TYPE = SPECIES_POSITIVE_PERK,
			SPECIES_PERK_ICON = "biohazard",
			SPECIES_PERK_NAME = "Viral Symbiosis",
			SPECIES_PERK_DESC = "Os hemofármacos, devido à sua condição, não podem ser infectados por outros vírus e não precisam de uma fonte externa de oxigênio para permanecer vivos.",
		),
		list(
			SPECIES_PERK_TYPE = SPECIES_NEGATIVE_PERK,
			SPECIES_PERK_ICON = "tint",
			SPECIES_PERK_NAME = "The Thirst",
			SPECIES_PERK_DESC = "Em vez de comer, os hemofágicos sofrem da sede, causada pelo tumor. Sede de quê? Sangue! Sua língua permite que agarrem as pessoas e bebam seu sangue, e sofrerão graves consequências se elas acabarem. Como nota, não importa de quem você bebe, tudo será convertido em seu tipo sanguíneo quando consumido. Dito isto, o sangue de outros humanóides sencientes parece saciar sua sede por mais tempo do que o sangue adquirido.",
		),
	)
...
/datum/species/hemophage/create_pref_blood_perks()
	...
	to_add += list(list(
		...
		SPECIES_PERK_DESC = "[plural_form]tem sangue que parece ser uma amálgama de todos os outros tipos sanguíneos, tornou possível graças a alguns antígenos especiais produzidos por seu tumor, tornando-os capazes de receber sangue de qualquer outro tipo, desde que ainda seja sangue humano.",
		),
	)
