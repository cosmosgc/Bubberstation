...
/obj/item/anointing_oil/proc/try_anoint(mob/living/target_mob, mob/living/user)
	...
	target_mob.visible_message(span_notice("[user]Inclina-se e mancha-se estrias geminadas de resplandecente hemorresina sobre[target_mob], em seguida, endireita com propósito ritual ..."))
