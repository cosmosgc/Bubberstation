...
/obj/machinery/vending/imported/yangyu
	name = "Fudobenda"
	desc = "Um vendedor vendendo comida tradicional Sol Eastern de qualidade duvidosa."
...
/obj/machinery/vending/imported/yangyu/examine_more(mob/user)
	. = ..()
	. += span_notice("Alguém parece ter escrito<i>\"Não confie no sushi!\"</i>no marcador do lado do vendedor.")
	return .
