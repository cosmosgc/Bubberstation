...
/datum/reagent/dinitrogen_plasmide
	...
	description = "Um composto de nitrogênio e plasma estabilizado, esta substância tem a capacidade de esfriar metais superaquecidos.\
evitando danos excessivos. Sendo um composto pesado, tem o efeito de retardar qualquer coisa que o metaboliza."
	ph = 4.8
...
/obj/item/reagent_containers/spray/dinitrogen_plasmide
	name = "coolant spray"
	desc = "Um frasco de spray médico. Este contém plasmídeo dinitrogênio, um potente refrigerante comumente usado para tratar queimaduras sintéticas.\
Tem o efeito colateral de causar a desaceleração do movimento."
