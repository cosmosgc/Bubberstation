...
/datum/wound/electrical_damage/pierce/moderate
	...
	treat_text = "Substituindo a fiação danificada, embora reparos através de instrumentos de corte ou suturas possam ser suficientes, embora com eficiência limitada. Em caso de emergência,\
O sujeito pode ser submetido a altas temperaturas para permitir que a solda retome."
...
/datum/wound/electrical_damage/pierce/critical
	...
	treat_text = "Segurança imediata via gaze, seguida por substituição de cabos de emergência e segurança via cortadores de arame ou hemostat.\
Se a falha se tornou incontrolável, terapia de calor extrema é recomendada."
