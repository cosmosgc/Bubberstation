...
/datum/nifsoft/summoner/book
	name = "Grimoire Akasha"
	program_desc = "Grimoire Akasha é um garfo do Grimoire Caeruleam NIFSoft que é projetado em torno de dar ao usuário acesso a vários livros educacionais de luz dura. Devido à sua natureza educacional e tamanho minúsculo, Grimoire Akasha é normalmente fornecido gratuitamente no máximo mercados NIFSoft."
