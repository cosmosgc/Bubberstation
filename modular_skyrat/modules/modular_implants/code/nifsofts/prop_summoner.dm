...
/datum/nifsoft/summoner
	name = "Grimoire Caeruleam"
	program_desc = "O Grimoire Caeruleam é um diretório de código aberto, virtual descentralizado de objetos convocáveis originalmente desenvolvido pelo Coven Altspace, um grupo pós-pagão de bruxas digitalizado pela primeira vez em engramas no ano 2544. Essas construções convocáveis, ou \"Ícones\", são compostas por padrões delicados de nanomáquinas que servem de estrutura e projetor para a luz dura; o nome \"Caeruleam.\" refere-se à luz azul que um ícone lança na mão do chamador. Enquanto o Grimoire serviu milhares até agora, interesses corporativos bloquearam todo o acesso a Ícones capazes de prejudicar seus bens."
	cooldown = TRUE
...
/datum/nifsoft/summoner/activate()
	...
	if(!linked_mob.put_in_hands(new_item))
		linked_mob.balloon_alert(linked_mob, "[new_item]Não se materializa em suas mãos!")
		qdel(new_item)
		refund_activation_cost()
		return FALSE
