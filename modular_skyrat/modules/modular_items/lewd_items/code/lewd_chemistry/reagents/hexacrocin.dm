...
/datum/reagent/drug/aphrodisiac/crocin/hexacrocin
	name = "hexacrocin"
	description = "Forma química condensada de crocina básica. Este afrodisíaco é extremamente poderoso e viciante para a maioria dos animais. Retiradas de vício podem causar danos cerebrais e falta de ar. Overdose pode levar a traumas cerebrais."
