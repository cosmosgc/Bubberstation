/datum/reagent/medicine/lidocaine
	name = "Lidocaine"
	description = "Um agente dormente usado frequentemente em cirurgias, metaboliza lentamente."
...
/datum/reagent/inverse/lidocaine
	name = "Lidopaine"
	description = "Um agente doloroso usado frequentemente para... ser um idiota, metaboliza mais rápido que lidocaína."
...
/datum/reagent/inverse/lidocaine/on_mob_life(mob/living/carbon/affected_mob, seconds_per_tick, times_fired)
	. = ..()
	to_chat(affected_mob, span_userdanger("Seu corpo dói com uma dor inimaginável!"))
...
/datum/reagent/medicine/coagulant/fabricated
	...
	description = "Um coagulante sintetizado criado por Mediguns."
