...
/obj/item/gun/ballistic/rifle/boltaction/sporterized
	...
	desc = "Um rifle Sakhno fortemente modificado, peças feitas por Xhihao braços leves baseados em torno de Júpiter. Tem uma capacidade maior que os rifles Sakhno padrão, montando oito cartuchos .310."
