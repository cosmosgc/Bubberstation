/datum/quirk/item_quirk/ration_system
	...
	desc = "Devido a alguma circunstância de sua vida, você se inscreveu no programa de tickets de ração, que vai reduzir para metade todos os seus salários em troca de conceder bilhetes de ração, que pode ser resgatado em um console de carga para comida e outros itens."
	icon = FA_ICON_DONATE
