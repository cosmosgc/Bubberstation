...
GLOBAL_LIST_INIT(stone_recipes, list ( 	new/datum/stack_recipe("stone brick wall", /turf/closed/wall/mineral/stone, 5, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND | CRAFT_TRANSFERS_REAGENT_COMPONENTS, category = CAT_STRUCTURE), 	new/datum/stack_recipe("stone brick tile", /obj/item/stack/tile/mineral/stone, 1, 4, 20, category = CAT_TILES),
...
/obj/item/stack/stone/examine()
	. = ..()
	. += span_notice("Comum<b>Cinzel.</b>U mesmo...<b>Pickaxe.</b>de algum tipo, você poderia cortar isso em<b>Blocos.</b>.")
