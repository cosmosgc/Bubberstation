...
/obj/item/skillchip/xenoarch_magnifier
	...
	desc = "Este biochip se integra com o cérebro do usuário para permitir o domínio de uma habilidade específica. Consultor certificado neurocirurgião Nanotrasen antes de usar.\
Há um rostinho gravado na parte de trás do chip de habilidade, com dentes de buck e óculos patetas."
