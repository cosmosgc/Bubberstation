...
/datum/controller/subsystem/vote/fire()
	...
	for(var/client/late_voter as anything in GLOB.clients)
		...
		to_chat(late_voter, vote_font(fieldset_block("[current_vote.name] Vote", "É hora de fazer suas escolhas! Digite \"votação\" ou clique.<a href='byond://winset?command=vote'>Aqui.</a>Para colocar seus votos.", "Caixa de mensagens roxas")))
