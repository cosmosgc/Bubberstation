...
/datum/quirk/dirty/post_add()
	...
	to_chat(quirk_holder, span_notice("Você está sujo! Você vai espalhar sujeira quando andar.\
Ser limpo removerá sua sujeira. Vasculhe uma pilha de lixo para recuperá-la."))
