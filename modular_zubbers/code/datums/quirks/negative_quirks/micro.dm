...
/datum/quirk/micro
	name = "Small"
	desc = "Por alguma razão, você é um pouco menor que a maioria. Você é 20 menor que os outros, com a desvantagem de ser facilmente esmagado!"
...
/datum/quirk/micro/smaller
	name = "Microsized"
	desc = "Você é 30% menor do que os outros... com a desvantagem de ser facilmente esmagado e ele dói!"
	icon = FA_ICON_LOCUST
	squash_damage_ = 15
	squash_chance_ = 40
	size_reduced = 0.7
...
/datum/quirk/micro/smallest
	name = "Microscopic"
	desc = "Você é 40% menor que os outros... As pessoas realmente apertam os olhos para te ver! Você também é esmagado como um inseto acidentalmente O tempo todo!"
...
/datum/quirk/micro/post_add()
	...
	living_as_carbon.AddComponent( 		/datum/component/squashable, 		squash_chance = squash_chance_, 		squash_damage = squash_damage_, 		squash_flags = SQUASHED_ALWAYS_IF_DEAD|SQUASHED_DONT_SQUASH_IN_CONTENTS|SQUASHED_SHOULD_BE_DOWN, 	)
