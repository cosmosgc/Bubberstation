/datum/quirk/egg_production
	...
	medical_record_text = "O paciente possui a capacidade de produzir ovos."
...
/datum/action/cooldown/spell/egg_production/cast(mob/living/cast_on)
	...
	owner.visible_message(span_noticealien("[owner] laid an egg!"), span_alertalien("Você botou um ovo!"))
	return TRUE
