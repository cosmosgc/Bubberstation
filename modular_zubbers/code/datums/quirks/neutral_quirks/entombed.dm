...
/datum/quirk/equipping/entombed/proc/life_support_failure()
	...
	human_holder.visible_message(span_danger("[human_holder] suddenly staggers, a dire pallor overtaking [human_holder.p_their()] features as a feeble 'breep' emanates from their suit..."), span_userdanger("O terror desce como o sistema de suporte de vida do seu terno está fraco, e então fica horrivelmente silencioso."))
	human_holder.balloon_alert(human_holder, UNLINT("Suit Life Suport Failling!"))
