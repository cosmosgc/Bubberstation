...
/datum/action/cooldown/bloodsucker/gohome
	name = "Vanishing Act"
	desc = "Como o amanhecer se aproxima, dispersem-se na névoa e retornem diretamente para seu Haven.<br><b>AVISO:</b>Você vai cair.<b>TODOS</b>de seus bens se observados por morteis."
...
/datum/action/cooldown/bloodsucker/gohome/ActivatePower(atom/target)
	owner.balloon_alert(owner, "Preparar para teletransporte...")
	return TRUE
