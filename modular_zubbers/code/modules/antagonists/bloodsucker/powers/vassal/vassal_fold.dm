/datum/action/cooldown/bloodsucker/ghoul_blood
	...
	power_explanation = "Help Ghoul:\n		Use this power while you have an ex-Ghoul grabbed to bring them back into the fold. 		Use this power with a bloodbag in your hand to instead fill it with Vampiric Blood which 		can be used to reset ex-ghoul deconversion timers. 		Right-Click will show the status of all Ghouls."
	check_flags = NONE
	purchase_flags = NONE
	bloodcost = 10
