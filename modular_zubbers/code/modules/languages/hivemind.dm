...
/datum/language/xenocommon/lesser_hivemind // Parent in \code\modules\language\xenocommon.dm
	...
	desc = "O método com o qual os híbridos Xenomorph são capazes de se comunicar silenciosamente em grandes distâncias ainda é mal compreendido, seja através de feromônios, algum tipo de rádio orgânico ou mesmo apenas telepatia, a realidade é que funciona."
	key = "5"
	icon_state = "xeno"
