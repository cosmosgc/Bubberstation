...
/datum/action/cooldown/spell/timestop/guardian
	...
	desc = "Este feitiço pára o tempo para todos, exceto para você e seu mestre, permitindo que você se mova livremente enquanto seus inimigos e até mesmo projéteis estão congelados."
