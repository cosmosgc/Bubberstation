...
/obj/item/organ/ears/cat/tajaran
	name = "Tajaran ears"
	desc = "Essas orelhas parecem ser de algum tipo de felino."
...
/datum/species/tajaran/create_pref_unique_perks()
	...
	to_add += list(
		list(
			...
			SPECIES_PERK_DESC = "Tajara leva mais tempo para esfriar quando pega fogo."
		),
		list(
			SPECIES_PERK_TYPE = SPECIES_NEGATIVE_PERK,
			SPECIES_PERK_ICON = "sun",
			SPECIES_PERK_NAME = "Bright Lights",
			SPECIES_PERK_DESC = "Tajara precisa de uma camada extra de proteção para proteger\
eles mesmos, como contra oficiais de segurança ou quando solda.",
		),
		list(
		...
		list(
			...
			SPECIES_PERK_DESC = "Tajara é parecida com um gato e tem instintos de gato que lhes permitem pousar de pé.\
Ao invés de ser derrubado por cair, você só recebe um curto abrandamento.\
No entanto, a queda causará danos adicionais, já que não são do tamanho e peso de um gato.",
		),
	)
