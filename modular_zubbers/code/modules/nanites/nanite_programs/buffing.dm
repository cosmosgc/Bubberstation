...
/datum/nanite_program/dermal_armor
	...
	desc = "Os nanites formam uma malha sob a pele do hospedeiro, protegendo-os de melee e impactos de bala. Cada golpe custa nanites duas vezes para danificar, mas quanto mais nanites você tem, mais proteção você tem. 50 nanites = 1 armadura plana, com cada golpe custando duas vezes é dano em nanites. Não ligará com outros programas de armaduras."
	use_rate = 2
...
/datum/nanite_program/dermal_armor/refractive
	...
	desc = "Os nanites formam uma membrana acima da pele do hospedeiro, reduzindo o efeito do laser e impactos de energia. Cada golpe custa nanites equilavent para danificar, mas quanto mais nanites você tem, mais proteção você tem. 50 nanites = 1 armadura plana, com cada golpe custando duas vezes é dano em nanites. Não ligará com outros programas de armaduras."
	damage_type = BURN
...
/datum/nanite_program/coagulating
	...
	desc = "Os nanites redireccionam sangue circulando para longe de festas abertas, reduzindo drásticamente a taxa de sangria."
	use_rate = 0.20
