...
/datum/nanite_program/aggressive_replication
	...
	desc = "Nanitas consumirão matéria orgânica para melhorar sua taxa de replicação, prejudicando o hospedeiro. A eficiência aumenta com o volume de nanites, exigindo 200 para quebrar o mesmo,\
e escalando linearmente para uma taxa de produção líquida positiva de 0,1 por 20 nanites."
	use_rate = 1
	rogue_types = list(/datum/nanite_program/necrotic)
...
/datum/nanite_program/meltdown
	name = "Meltdown"
	desc = "Causa um colapso interno dentro dos nanites, causando queimaduras internas dentro do hospedeiro, bem como rapidamente destruindo a população nanite.\
Coloca o limiar de segurança dos nanites em 0 quando ativados."
	use_rate = 10
...
/datum/nanite_program/meltdown/disable_passive_effect()
	. = ..()
	to_chat(host_mob, span_warning("Seu sangue esfria, e a dor gradualmente desaparece."))
...
/datum/nanite_program/explosive/on_trigger(comm_message)
	host_mob.visible_message(span_warning("[host_mob] starts emitting a high-pitched buzzing, and [host_mob.p_their()] skin begins to glow..."),\
							span_userdanger("Você começa a emitir um zumbido agudo, e sua pele começa a brilhar..."))
