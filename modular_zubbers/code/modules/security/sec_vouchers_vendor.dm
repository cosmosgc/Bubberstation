...
/obj/item/security_voucher/examine(mob/user)
	...
	. += span_notice("Você pode redimi-lo em um[EXAMINE_HINT("security equipment vendor")]UO[EXAMINE_HINT("any lathe")].")
...
/datum/voucher_set/security/primary/disabler_smg
	name = "Pepperball AGH"
	description = "Uma arma de fogo mais lenta que dispara \"Bolas de pimenta.\", que facilmente lança alvos para o chão."
