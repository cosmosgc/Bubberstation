/obj/item/gun/ballistic/rocketlauncher/security
	...
	desc = "Um lançador de mísseis barato e reutilizável, preparado pelos malucos dos laboratórios de desenvolvimento de armas Nanotrasen, para lidar com esses bandidos espaciais. Uso especial patenteado 69mm\"Fogo e fuhgeddaboudit\"mísseis que alojam alvos com grandes assinaturas de radar, incluindo paredes, pisos, e o mais importante, pessoas."
