...
/proc/spawn_pirates(datum/comm_message/threat, datum/pirate_gang/chosen_gang)
	...
	var/list/candidates = SSpolling.poll_ghost_candidates("Do you wish to be considered for a [span_notice("pirate crew of [chosen_gang.name]?")]", check_jobban = ROLE_TRAITOR, alert_pic = /obj/item/claymore/cutlass, role_name_text = "tripulação pirata")
...
/datum/event_admin_setup/listed_options/pirates
	input_text = "Escolha a gangue pirata."
