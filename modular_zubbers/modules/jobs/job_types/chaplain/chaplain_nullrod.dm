...
/obj/item/nullrod/sylvanstaff/Initialize(mapload)
	. = ..()
	AddElement(
		/datum/element/chemical_transfer,		span_notice("Você sente seu corpo sendo limpo"),		span_userdanger("Você sente a transferência de impurezas dentro de você."),		CHEMICAL_TRANSFER_CHANCE	)
